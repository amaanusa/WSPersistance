...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateOh.findAll", query = "SELECT s FROM StateOh s"),
    @NamedQuery(name = "StateOh.findByCompanyName", query = "SELECT s FROM StateOh s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateOh.findByMailingAddress", query = "SELECT s FROM StateOh s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateOh.findByCity", query = "SELECT s FROM StateOh s WHERE s.city = :city"),
    @NamedQuery(name = "StateOh.findByState", query = "SELECT s FROM StateOh s WHERE s.state = :state"),
    @NamedQuery(name = "StateOh.findByZipCode", query = "SELECT s FROM StateOh s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateOh.findByMailingCarrierRoute", query = "SELECT s FROM StateOh s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateOh.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateOh s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateOh.findByStreetAddressCity", query = "SELECT s FROM StateOh s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateOh.findByStreetAddress", query = "SELECT s FROM StateOh s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateOh.findByStreetAddressZip", query = "SELECT s FROM StateOh s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateOh.findByStreetAddressZip4", query = "SELECT s FROM StateOh s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateOh.findByCounty", query = "SELECT s FROM StateOh s WHERE s.county = :county"),
    @NamedQuery(name = "StateOh.findByPhoneNumber", query = "SELECT s FROM StateOh s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateOh.findByFaxNumber", query = "SELECT s FROM StateOh s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateOh.findByWebAddress", query = "SELECT s FROM StateOh s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateOh.findByLastName", query = "SELECT s FROM StateOh s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateOh.findByFirstName", query = "SELECT s FROM StateOh s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateOh.findByContactTitle", query = "SELECT s FROM StateOh s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateOh.findByContactGender", query = "SELECT s FROM StateOh s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateOh.findByActualEmployeeSize", query = "SELECT s FROM StateOh s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateOh.findByEmployeeSizeRange", query = "SELECT s FROM StateOh s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateOh.findByActualSalesVolume", query = "SELECT s FROM StateOh s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateOh.findBySalesVolumeRange", query = "SELECT s FROM StateOh s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateOh.findByPrimarySic", query = "SELECT s FROM StateOh s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateOh.findByPrimarySicDescription", query = "SELECT s FROM StateOh s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateOh.findBySecondarySic1", query = "SELECT s FROM StateOh s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateOh.findBySecondarySicDescription1", query = "SELECT s FROM StateOh s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateOh.findBySecondarySic2", query = "SELECT s FROM StateOh s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateOh.findBySecondarySicDescription2", query = "SELECT s FROM StateOh s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateOh.findByCreditAlphaScore", query = "SELECT s FROM StateOh s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateOh.findByCreditNumericScore", query = "SELECT s FROM StateOh s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateOh.findByHeadquartersbranch", query = "SELECT s FROM StateOh s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateOh.findByOfficeSize", query = "SELECT s FROM StateOh s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateOh.findBySquareFootage", query = "SELECT s FROM StateOh s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateOh.findByFirmindividual", query = "SELECT s FROM StateOh s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateOh.findByPublicprivateFlag", query = "SELECT s FROM StateOh s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateOh.findByPcCode", query = "SELECT s FROM StateOh s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateOh.findByFranchisespecialty1", query = "SELECT s FROM StateOh s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateOh.findByFranchisespecialty2", query = "SELECT s FROM StateOh s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateOh.findByIndustrySpecificCodes", query = "SELECT s FROM StateOh s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateOh.findByAdsizeInYellowPages", query = "SELECT s FROM StateOh s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateOh.findByMetroArea", query = "SELECT s FROM StateOh s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateOh.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateOh s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateOh.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateOh s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateOh.findByRownum", query = "SELECT s FROM StateOh s WHERE s.rownum = :rownum")})
public class StateOh implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateOh)) {
            return false;
        }
        StateOh other = (StateOh) object;
    ...
    public String toString() {
        return "src.entities.StateOh[ rownum=" + rownum + " ]";
    }

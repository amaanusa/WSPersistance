...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateMi.findAll", query = "SELECT s FROM StateMi s"),
    @NamedQuery(name = "StateMi.findByCompanyName", query = "SELECT s FROM StateMi s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateMi.findByMailingAddress", query = "SELECT s FROM StateMi s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateMi.findByCity", query = "SELECT s FROM StateMi s WHERE s.city = :city"),
    @NamedQuery(name = "StateMi.findByState", query = "SELECT s FROM StateMi s WHERE s.state = :state"),
    @NamedQuery(name = "StateMi.findByZipCode", query = "SELECT s FROM StateMi s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateMi.findByMailingCarrierRoute", query = "SELECT s FROM StateMi s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateMi.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateMi s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateMi.findByStreetAddress", query = "SELECT s FROM StateMi s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateMi.findByStreetAddressCity", query = "SELECT s FROM StateMi s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateMi.findByStreetAddressState", query = "SELECT s FROM StateMi s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateMi.findByStreetAddressZip", query = "SELECT s FROM StateMi s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateMi.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateMi s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateMi.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateMi s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateMi.findByCounty", query = "SELECT s FROM StateMi s WHERE s.county = :county"),
    @NamedQuery(name = "StateMi.findByPhoneNumber", query = "SELECT s FROM StateMi s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateMi.findByFaxNumber", query = "SELECT s FROM StateMi s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateMi.findByWebAddress", query = "SELECT s FROM StateMi s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateMi.findByLastName", query = "SELECT s FROM StateMi s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateMi.findByFirstName", query = "SELECT s FROM StateMi s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateMi.findByContactTitle", query = "SELECT s FROM StateMi s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateMi.findByContactGender", query = "SELECT s FROM StateMi s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateMi.findByActualEmployeeSize", query = "SELECT s FROM StateMi s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateMi.findByEmployeeSizeRange", query = "SELECT s FROM StateMi s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateMi.findByActualSalesVolume", query = "SELECT s FROM StateMi s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateMi.findBySalesVolumeRange", query = "SELECT s FROM StateMi s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateMi.findByPrimarySic", query = "SELECT s FROM StateMi s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateMi.findByPrimarySicDescription", query = "SELECT s FROM StateMi s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateMi.findBySecondarySic1", query = "SELECT s FROM StateMi s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateMi.findBySecondarySicDescription1", query = "SELECT s FROM StateMi s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateMi.findBySecondarySic2", query = "SELECT s FROM StateMi s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateMi.findBySecondarySicDescription2", query = "SELECT s FROM StateMi s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateMi.findByCreditAlphaScore", query = "SELECT s FROM StateMi s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateMi.findByCreditNumericScore", query = "SELECT s FROM StateMi s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateMi.findByHeadquartersbranch", query = "SELECT s FROM StateMi s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateMi.findByOfficeSize", query = "SELECT s FROM StateMi s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateMi.findBySquareFootage", query = "SELECT s FROM StateMi s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateMi.findByFirmindividual", query = "SELECT s FROM StateMi s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateMi.findByPublicprivateFlag", query = "SELECT s FROM StateMi s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateMi.findByPcCode", query = "SELECT s FROM StateMi s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateMi.findByFranchisespecialty1", query = "SELECT s FROM StateMi s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateMi.findByFranchisespecialty2", query = "SELECT s FROM StateMi s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateMi.findByIndustrySpecificCodes", query = "SELECT s FROM StateMi s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateMi.findByAdsizeInYellowPages", query = "SELECT s FROM StateMi s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateMi.findByMetroArea", query = "SELECT s FROM StateMi s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateMi.findByRownum", query = "SELECT s FROM StateMi s WHERE s.rownum = :rownum")})
public class StateMi implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateMi)) {
            return false;
        }
        StateMi other = (StateMi) object;
    ...
    public String toString() {
        return "src.entities.StateMi[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateOk.findAll", query = "SELECT s FROM StateOk s"),
    @NamedQuery(name = "StateOk.findByCompanyName", query = "SELECT s FROM StateOk s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateOk.findByMailingAddress", query = "SELECT s FROM StateOk s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateOk.findByCity", query = "SELECT s FROM StateOk s WHERE s.city = :city"),
    @NamedQuery(name = "StateOk.findByState", query = "SELECT s FROM StateOk s WHERE s.state = :state"),
    @NamedQuery(name = "StateOk.findByZipCode", query = "SELECT s FROM StateOk s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateOk.findByMailingCarrierRoute", query = "SELECT s FROM StateOk s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateOk.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateOk s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateOk.findByStreetAddressCity", query = "SELECT s FROM StateOk s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateOk.findByStreetAddress", query = "SELECT s FROM StateOk s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateOk.findByStreetAddressZip", query = "SELECT s FROM StateOk s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateOk.findByStreetAddressZip4", query = "SELECT s FROM StateOk s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateOk.findByCounty", query = "SELECT s FROM StateOk s WHERE s.county = :county"),
    @NamedQuery(name = "StateOk.findByPhoneNumber", query = "SELECT s FROM StateOk s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateOk.findByFaxNumber", query = "SELECT s FROM StateOk s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateOk.findByWebAddress", query = "SELECT s FROM StateOk s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateOk.findByLastName", query = "SELECT s FROM StateOk s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateOk.findByFirstName", query = "SELECT s FROM StateOk s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateOk.findByContactTitle", query = "SELECT s FROM StateOk s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateOk.findByContactGender", query = "SELECT s FROM StateOk s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateOk.findByActualEmployeeSize", query = "SELECT s FROM StateOk s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateOk.findByEmployeeSizeRange", query = "SELECT s FROM StateOk s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateOk.findByActualSalesVolume", query = "SELECT s FROM StateOk s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateOk.findBySalesVolumeRange", query = "SELECT s FROM StateOk s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateOk.findByPrimarySic", query = "SELECT s FROM StateOk s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateOk.findByPrimarySicDescription", query = "SELECT s FROM StateOk s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateOk.findBySecondarySic1", query = "SELECT s FROM StateOk s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateOk.findBySecondarySicDescription1", query = "SELECT s FROM StateOk s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateOk.findBySecondarySic2", query = "SELECT s FROM StateOk s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateOk.findBySecondarySicDescription2", query = "SELECT s FROM StateOk s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateOk.findByCreditAlphaScore", query = "SELECT s FROM StateOk s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateOk.findByCreditNumericScore", query = "SELECT s FROM StateOk s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateOk.findByHeadquartersbranch", query = "SELECT s FROM StateOk s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateOk.findByOfficeSize", query = "SELECT s FROM StateOk s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateOk.findBySquareFootage", query = "SELECT s FROM StateOk s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateOk.findByFirmindividual", query = "SELECT s FROM StateOk s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateOk.findByPublicprivateFlag", query = "SELECT s FROM StateOk s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateOk.findByPcCode", query = "SELECT s FROM StateOk s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateOk.findByFranchisespecialty1", query = "SELECT s FROM StateOk s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateOk.findByFranchisespecialty2", query = "SELECT s FROM StateOk s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateOk.findByIndustrySpecificCodes", query = "SELECT s FROM StateOk s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateOk.findByAdsizeInYellowPages", query = "SELECT s FROM StateOk s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateOk.findByMetroArea", query = "SELECT s FROM StateOk s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateOk.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateOk s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateOk.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateOk s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateOk.findByRownum", query = "SELECT s FROM StateOk s WHERE s.rownum = :rownum")})
public class StateOk implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateOk)) {
            return false;
        }
        StateOk other = (StateOk) object;
    ...
    public String toString() {
        return "src.entities.StateOk[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateId.findAll", query = "SELECT s FROM StateId s"),
    @NamedQuery(name = "StateId.findByCompanyName", query = "SELECT s FROM StateId s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateId.findByMailingAddress", query = "SELECT s FROM StateId s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateId.findByCity", query = "SELECT s FROM StateId s WHERE s.city = :city"),
    @NamedQuery(name = "StateId.findByState", query = "SELECT s FROM StateId s WHERE s.state = :state"),
    @NamedQuery(name = "StateId.findByZipCode", query = "SELECT s FROM StateId s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateId.findByMailingCarrierRoute", query = "SELECT s FROM StateId s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateId.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateId s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateId.findByStreetAddress", query = "SELECT s FROM StateId s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateId.findByStreetAddressCity", query = "SELECT s FROM StateId s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateId.findByStreetAddressState", query = "SELECT s FROM StateId s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateId.findByStreetAddressZip", query = "SELECT s FROM StateId s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateId.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateId s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateId.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateId s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateId.findByCounty", query = "SELECT s FROM StateId s WHERE s.county = :county"),
    @NamedQuery(name = "StateId.findByPhoneNumber", query = "SELECT s FROM StateId s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateId.findByFaxNumber", query = "SELECT s FROM StateId s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateId.findByWebAddress", query = "SELECT s FROM StateId s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateId.findByLastName", query = "SELECT s FROM StateId s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateId.findByFirstName", query = "SELECT s FROM StateId s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateId.findByContactTitle", query = "SELECT s FROM StateId s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateId.findByContactGender", query = "SELECT s FROM StateId s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateId.findByActualEmployeeSize", query = "SELECT s FROM StateId s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateId.findByEmployeeSizeRange", query = "SELECT s FROM StateId s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateId.findByActualSalesVolume", query = "SELECT s FROM StateId s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateId.findBySalesVolumeRange", query = "SELECT s FROM StateId s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateId.findByPrimarySic", query = "SELECT s FROM StateId s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateId.findByPrimarySicDescription", query = "SELECT s FROM StateId s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateId.findBySecondarySic1", query = "SELECT s FROM StateId s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateId.findBySecondarySicDescription1", query = "SELECT s FROM StateId s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateId.findBySecondarySic2", query = "SELECT s FROM StateId s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateId.findBySecondarySicDescription2", query = "SELECT s FROM StateId s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateId.findByCreditAlphaScore", query = "SELECT s FROM StateId s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateId.findByCreditNumericScore", query = "SELECT s FROM StateId s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateId.findByHeadquartersbranch", query = "SELECT s FROM StateId s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateId.findByOfficeSize", query = "SELECT s FROM StateId s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateId.findBySquareFootage", query = "SELECT s FROM StateId s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateId.findByFirmindividual", query = "SELECT s FROM StateId s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateId.findByPublicprivateFlag", query = "SELECT s FROM StateId s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateId.findByPcCode", query = "SELECT s FROM StateId s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateId.findByFranchisespecialty1", query = "SELECT s FROM StateId s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateId.findByFranchisespecialty2", query = "SELECT s FROM StateId s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateId.findByIndustrySpecificCodes", query = "SELECT s FROM StateId s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateId.findByAdsizeInYellowPages", query = "SELECT s FROM StateId s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateId.findByMetroArea", query = "SELECT s FROM StateId s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateId.findByRownum", query = "SELECT s FROM StateId s WHERE s.rownum = :rownum")})
public class StateId implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateId)) {
            return false;
        }
        StateId other = (StateId) object;
    ...
    public String toString() {
        return "src.entities.StateId[ rownum=" + rownum + " ]";
    }

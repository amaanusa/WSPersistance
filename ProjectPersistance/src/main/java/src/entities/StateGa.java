...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateGa.findAll", query = "SELECT s FROM StateGa s"),
    @NamedQuery(name = "StateGa.findByCompanyName", query = "SELECT s FROM StateGa s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateGa.findByMailingAddress", query = "SELECT s FROM StateGa s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateGa.findByCity", query = "SELECT s FROM StateGa s WHERE s.city = :city"),
    @NamedQuery(name = "StateGa.findByState", query = "SELECT s FROM StateGa s WHERE s.state = :state"),
    @NamedQuery(name = "StateGa.findByZipCode", query = "SELECT s FROM StateGa s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateGa.findByMailingCarrierRoute", query = "SELECT s FROM StateGa s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateGa.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateGa s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateGa.findByStreetAddress", query = "SELECT s FROM StateGa s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateGa.findByStreetAddressCity", query = "SELECT s FROM StateGa s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateGa.findByStreetAddressState", query = "SELECT s FROM StateGa s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateGa.findByStreetAddressZip", query = "SELECT s FROM StateGa s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateGa.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateGa s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateGa.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateGa s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateGa.findByCounty", query = "SELECT s FROM StateGa s WHERE s.county = :county"),
    @NamedQuery(name = "StateGa.findByPhoneNumber", query = "SELECT s FROM StateGa s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateGa.findByFaxNumber", query = "SELECT s FROM StateGa s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateGa.findByWebAddress", query = "SELECT s FROM StateGa s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateGa.findByLastName", query = "SELECT s FROM StateGa s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateGa.findByFirstName", query = "SELECT s FROM StateGa s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateGa.findByContactTitle", query = "SELECT s FROM StateGa s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateGa.findByContactGender", query = "SELECT s FROM StateGa s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateGa.findByActualEmployeeSize", query = "SELECT s FROM StateGa s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateGa.findByEmployeeSizeRange", query = "SELECT s FROM StateGa s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateGa.findByActualSalesVolume", query = "SELECT s FROM StateGa s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateGa.findBySalesVolumeRange", query = "SELECT s FROM StateGa s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateGa.findByPrimarySic", query = "SELECT s FROM StateGa s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateGa.findByPrimarySicDescription", query = "SELECT s FROM StateGa s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateGa.findBySecondarySic1", query = "SELECT s FROM StateGa s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateGa.findBySecondarySicDescription1", query = "SELECT s FROM StateGa s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateGa.findBySecondarySic2", query = "SELECT s FROM StateGa s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateGa.findBySecondarySicDescription2", query = "SELECT s FROM StateGa s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateGa.findByCreditAlphaScore", query = "SELECT s FROM StateGa s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateGa.findByCreditNumericScore", query = "SELECT s FROM StateGa s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateGa.findByHeadquartersbranch", query = "SELECT s FROM StateGa s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateGa.findByOfficeSize", query = "SELECT s FROM StateGa s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateGa.findBySquareFootage", query = "SELECT s FROM StateGa s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateGa.findByFirmindividual", query = "SELECT s FROM StateGa s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateGa.findByPublicprivateFlag", query = "SELECT s FROM StateGa s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateGa.findByPcCode", query = "SELECT s FROM StateGa s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateGa.findByFranchisespecialty1", query = "SELECT s FROM StateGa s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateGa.findByFranchisespecialty2", query = "SELECT s FROM StateGa s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateGa.findByIndustrySpecificCodes", query = "SELECT s FROM StateGa s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateGa.findByAdsizeInYellowPages", query = "SELECT s FROM StateGa s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateGa.findByMetroArea", query = "SELECT s FROM StateGa s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateGa.findByRownum", query = "SELECT s FROM StateGa s WHERE s.rownum = :rownum")})
public class StateGa implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateGa)) {
            return false;
        }
        StateGa other = (StateGa) object;
    ...
    public String toString() {
        return "src.entities.StateGa[ rownum=" + rownum + " ]";
    }

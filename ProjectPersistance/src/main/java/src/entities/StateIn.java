...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateIn.findAll", query = "SELECT s FROM StateIn s"),
    @NamedQuery(name = "StateIn.findByCompanyName", query = "SELECT s FROM StateIn s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateIn.findByMailingAddress", query = "SELECT s FROM StateIn s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateIn.findByCity", query = "SELECT s FROM StateIn s WHERE s.city = :city"),
    @NamedQuery(name = "StateIn.findByState", query = "SELECT s FROM StateIn s WHERE s.state = :state"),
    @NamedQuery(name = "StateIn.findByZipCode", query = "SELECT s FROM StateIn s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateIn.findByMailingCarrierRoute", query = "SELECT s FROM StateIn s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateIn.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateIn s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateIn.findByStreetAddressCity", query = "SELECT s FROM StateIn s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateIn.findByStreetAddress", query = "SELECT s FROM StateIn s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateIn.findByStreetAddressZip", query = "SELECT s FROM StateIn s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateIn.findByStreetAddressZip4", query = "SELECT s FROM StateIn s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateIn.findByCounty", query = "SELECT s FROM StateIn s WHERE s.county = :county"),
    @NamedQuery(name = "StateIn.findByPhoneNumber", query = "SELECT s FROM StateIn s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateIn.findByFaxNumber", query = "SELECT s FROM StateIn s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateIn.findByWebAddress", query = "SELECT s FROM StateIn s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateIn.findByLastName", query = "SELECT s FROM StateIn s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateIn.findByFirstName", query = "SELECT s FROM StateIn s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateIn.findByContactTitle", query = "SELECT s FROM StateIn s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateIn.findByContactGender", query = "SELECT s FROM StateIn s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateIn.findByActualEmployeeSize", query = "SELECT s FROM StateIn s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateIn.findByEmployeeSizeRange", query = "SELECT s FROM StateIn s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateIn.findByActualSalesVolume", query = "SELECT s FROM StateIn s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateIn.findBySalesVolumeRange", query = "SELECT s FROM StateIn s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateIn.findByPrimarySic", query = "SELECT s FROM StateIn s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateIn.findByPrimarySicDescription", query = "SELECT s FROM StateIn s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateIn.findBySecondarySic1", query = "SELECT s FROM StateIn s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateIn.findBySecondarySicDescription1", query = "SELECT s FROM StateIn s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateIn.findBySecondarySic2", query = "SELECT s FROM StateIn s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateIn.findBySecondarySicDescription2", query = "SELECT s FROM StateIn s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateIn.findByCreditAlphaScore", query = "SELECT s FROM StateIn s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateIn.findByCreditNumericScore", query = "SELECT s FROM StateIn s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateIn.findByHeadquartersbranch", query = "SELECT s FROM StateIn s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateIn.findByOfficeSize", query = "SELECT s FROM StateIn s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateIn.findBySquareFootage", query = "SELECT s FROM StateIn s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateIn.findByFirmindividual", query = "SELECT s FROM StateIn s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateIn.findByPublicprivateFlag", query = "SELECT s FROM StateIn s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateIn.findByPcCode", query = "SELECT s FROM StateIn s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateIn.findByFranchisespecialty1", query = "SELECT s FROM StateIn s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateIn.findByFranchisespecialty2", query = "SELECT s FROM StateIn s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateIn.findByIndustrySpecificCodes", query = "SELECT s FROM StateIn s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateIn.findByAdsizeInYellowPages", query = "SELECT s FROM StateIn s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateIn.findByMetroArea", query = "SELECT s FROM StateIn s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateIn.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateIn s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateIn.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateIn s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateIn.findByRownum", query = "SELECT s FROM StateIn s WHERE s.rownum = :rownum")})
public class StateIn implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateIn)) {
            return false;
        }
        StateIn other = (StateIn) object;
    ...
    public String toString() {
        return "src.entities.StateIn[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateOr.findAll", query = "SELECT s FROM StateOr s"),
    @NamedQuery(name = "StateOr.findByCompanyName", query = "SELECT s FROM StateOr s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateOr.findByMailingAddress", query = "SELECT s FROM StateOr s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateOr.findByCity", query = "SELECT s FROM StateOr s WHERE s.city = :city"),
    @NamedQuery(name = "StateOr.findByState", query = "SELECT s FROM StateOr s WHERE s.state = :state"),
    @NamedQuery(name = "StateOr.findByZipCode", query = "SELECT s FROM StateOr s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateOr.findByMailingCarrierRoute", query = "SELECT s FROM StateOr s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateOr.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateOr s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateOr.findByStreetAddressCity", query = "SELECT s FROM StateOr s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateOr.findByStreetAddress", query = "SELECT s FROM StateOr s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateOr.findByStreetAddressZip", query = "SELECT s FROM StateOr s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateOr.findByStreetAddressZip4", query = "SELECT s FROM StateOr s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateOr.findByCounty", query = "SELECT s FROM StateOr s WHERE s.county = :county"),
    @NamedQuery(name = "StateOr.findByPhoneNumber", query = "SELECT s FROM StateOr s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateOr.findByFaxNumber", query = "SELECT s FROM StateOr s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateOr.findByWebAddress", query = "SELECT s FROM StateOr s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateOr.findByLastName", query = "SELECT s FROM StateOr s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateOr.findByFirstName", query = "SELECT s FROM StateOr s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateOr.findByContactTitle", query = "SELECT s FROM StateOr s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateOr.findByContactGender", query = "SELECT s FROM StateOr s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateOr.findByActualEmployeeSize", query = "SELECT s FROM StateOr s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateOr.findByEmployeeSizeRange", query = "SELECT s FROM StateOr s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateOr.findByActualSalesVolume", query = "SELECT s FROM StateOr s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateOr.findBySalesVolumeRange", query = "SELECT s FROM StateOr s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateOr.findByPrimarySic", query = "SELECT s FROM StateOr s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateOr.findByPrimarySicDescription", query = "SELECT s FROM StateOr s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateOr.findBySecondarySic1", query = "SELECT s FROM StateOr s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateOr.findBySecondarySicDescription1", query = "SELECT s FROM StateOr s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateOr.findBySecondarySic2", query = "SELECT s FROM StateOr s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateOr.findBySecondarySicDescription2", query = "SELECT s FROM StateOr s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateOr.findByCreditAlphaScore", query = "SELECT s FROM StateOr s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateOr.findByCreditNumericScore", query = "SELECT s FROM StateOr s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateOr.findByHeadquartersbranch", query = "SELECT s FROM StateOr s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateOr.findByOfficeSize", query = "SELECT s FROM StateOr s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateOr.findBySquareFootage", query = "SELECT s FROM StateOr s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateOr.findByFirmindividual", query = "SELECT s FROM StateOr s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateOr.findByPublicprivateFlag", query = "SELECT s FROM StateOr s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateOr.findByPcCode", query = "SELECT s FROM StateOr s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateOr.findByFranchisespecialty1", query = "SELECT s FROM StateOr s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateOr.findByFranchisespecialty2", query = "SELECT s FROM StateOr s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateOr.findByIndustrySpecificCodes", query = "SELECT s FROM StateOr s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateOr.findByAdsizeInYellowPages", query = "SELECT s FROM StateOr s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateOr.findByMetroArea", query = "SELECT s FROM StateOr s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateOr.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateOr s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateOr.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateOr s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateOr.findByRownum", query = "SELECT s FROM StateOr s WHERE s.rownum = :rownum")})
public class StateOr implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateOr)) {
            return false;
        }
        StateOr other = (StateOr) object;
    ...
    public String toString() {
        return "src.entities.StateOr[ rownum=" + rownum + " ]";
    }

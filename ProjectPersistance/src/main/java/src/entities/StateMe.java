...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateMe.findAll", query = "SELECT s FROM StateMe s"),
    @NamedQuery(name = "StateMe.findByCompanyName", query = "SELECT s FROM StateMe s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateMe.findByMailingAddress", query = "SELECT s FROM StateMe s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateMe.findByCity", query = "SELECT s FROM StateMe s WHERE s.city = :city"),
    @NamedQuery(name = "StateMe.findByState", query = "SELECT s FROM StateMe s WHERE s.state = :state"),
    @NamedQuery(name = "StateMe.findByZipCode", query = "SELECT s FROM StateMe s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateMe.findByMailingCarrierRoute", query = "SELECT s FROM StateMe s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateMe.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateMe s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateMe.findByStreetAddress", query = "SELECT s FROM StateMe s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateMe.findByStreetAddressCity", query = "SELECT s FROM StateMe s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateMe.findByStreetAddressState", query = "SELECT s FROM StateMe s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateMe.findByStreetAddressZip", query = "SELECT s FROM StateMe s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateMe.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateMe s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateMe.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateMe s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateMe.findByCounty", query = "SELECT s FROM StateMe s WHERE s.county = :county"),
    @NamedQuery(name = "StateMe.findByPhoneNumber", query = "SELECT s FROM StateMe s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateMe.findByFaxNumber", query = "SELECT s FROM StateMe s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateMe.findByWebAddress", query = "SELECT s FROM StateMe s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateMe.findByLastName", query = "SELECT s FROM StateMe s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateMe.findByFirstName", query = "SELECT s FROM StateMe s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateMe.findByContactTitle", query = "SELECT s FROM StateMe s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateMe.findByContactGender", query = "SELECT s FROM StateMe s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateMe.findByActualEmployeeSize", query = "SELECT s FROM StateMe s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateMe.findByEmployeeSizeRange", query = "SELECT s FROM StateMe s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateMe.findByActualSalesVolume", query = "SELECT s FROM StateMe s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateMe.findBySalesVolumeRange", query = "SELECT s FROM StateMe s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateMe.findByPrimarySic", query = "SELECT s FROM StateMe s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateMe.findByPrimarySicDescription", query = "SELECT s FROM StateMe s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateMe.findBySecondarySic1", query = "SELECT s FROM StateMe s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateMe.findBySecondarySicDescription1", query = "SELECT s FROM StateMe s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateMe.findBySecondarySic2", query = "SELECT s FROM StateMe s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateMe.findBySecondarySicDescription2", query = "SELECT s FROM StateMe s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateMe.findByCreditAlphaScore", query = "SELECT s FROM StateMe s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateMe.findByCreditNumericScore", query = "SELECT s FROM StateMe s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateMe.findByHeadquartersbranch", query = "SELECT s FROM StateMe s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateMe.findByOfficeSize", query = "SELECT s FROM StateMe s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateMe.findBySquareFootage", query = "SELECT s FROM StateMe s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateMe.findByFirmindividual", query = "SELECT s FROM StateMe s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateMe.findByPublicprivateFlag", query = "SELECT s FROM StateMe s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateMe.findByPcCode", query = "SELECT s FROM StateMe s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateMe.findByFranchisespecialty1", query = "SELECT s FROM StateMe s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateMe.findByFranchisespecialty2", query = "SELECT s FROM StateMe s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateMe.findByIndustrySpecificCodes", query = "SELECT s FROM StateMe s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateMe.findByAdsizeInYellowPages", query = "SELECT s FROM StateMe s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateMe.findByMetroArea", query = "SELECT s FROM StateMe s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateMe.findByRownum", query = "SELECT s FROM StateMe s WHERE s.rownum = :rownum")})
public class StateMe implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateMe)) {
            return false;
        }
        StateMe other = (StateMe) object;
    ...
    public String toString() {
        return "src.entities.StateMe[ rownum=" + rownum + " ]";
    }

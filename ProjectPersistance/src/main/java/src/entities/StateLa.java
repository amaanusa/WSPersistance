...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateLa.findAll", query = "SELECT s FROM StateLa s"),
    @NamedQuery(name = "StateLa.findByCompanyName", query = "SELECT s FROM StateLa s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateLa.findByMailingAddress", query = "SELECT s FROM StateLa s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateLa.findByCity", query = "SELECT s FROM StateLa s WHERE s.city = :city"),
    @NamedQuery(name = "StateLa.findByState", query = "SELECT s FROM StateLa s WHERE s.state = :state"),
    @NamedQuery(name = "StateLa.findByZipCode", query = "SELECT s FROM StateLa s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateLa.findByMailingCarrierRoute", query = "SELECT s FROM StateLa s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateLa.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateLa s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateLa.findByStreetAddress", query = "SELECT s FROM StateLa s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateLa.findByStreetAddressCity", query = "SELECT s FROM StateLa s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateLa.findByStreetAddressState", query = "SELECT s FROM StateLa s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateLa.findByStreetAddressZip", query = "SELECT s FROM StateLa s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateLa.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateLa s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateLa.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateLa s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateLa.findByCounty", query = "SELECT s FROM StateLa s WHERE s.county = :county"),
    @NamedQuery(name = "StateLa.findByPhoneNumber", query = "SELECT s FROM StateLa s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateLa.findByFaxNumber", query = "SELECT s FROM StateLa s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateLa.findByWebAddress", query = "SELECT s FROM StateLa s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateLa.findByLastName", query = "SELECT s FROM StateLa s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateLa.findByFirstName", query = "SELECT s FROM StateLa s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateLa.findByContactTitle", query = "SELECT s FROM StateLa s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateLa.findByContactGender", query = "SELECT s FROM StateLa s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateLa.findByActualEmployeeSize", query = "SELECT s FROM StateLa s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateLa.findByEmployeeSizeRange", query = "SELECT s FROM StateLa s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateLa.findByActualSalesVolume", query = "SELECT s FROM StateLa s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateLa.findBySalesVolumeRange", query = "SELECT s FROM StateLa s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateLa.findByPrimarySic", query = "SELECT s FROM StateLa s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateLa.findByPrimarySicDescription", query = "SELECT s FROM StateLa s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateLa.findBySecondarySic1", query = "SELECT s FROM StateLa s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateLa.findBySecondarySicDescription1", query = "SELECT s FROM StateLa s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateLa.findBySecondarySic2", query = "SELECT s FROM StateLa s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateLa.findBySecondarySicDescription2", query = "SELECT s FROM StateLa s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateLa.findByCreditAlphaScore", query = "SELECT s FROM StateLa s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateLa.findByCreditNumericScore", query = "SELECT s FROM StateLa s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateLa.findByHeadquartersbranch", query = "SELECT s FROM StateLa s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateLa.findByOfficeSize", query = "SELECT s FROM StateLa s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateLa.findBySquareFootage", query = "SELECT s FROM StateLa s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateLa.findByFirmindividual", query = "SELECT s FROM StateLa s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateLa.findByPublicprivateFlag", query = "SELECT s FROM StateLa s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateLa.findByPcCode", query = "SELECT s FROM StateLa s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateLa.findByFranchisespecialty1", query = "SELECT s FROM StateLa s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateLa.findByFranchisespecialty2", query = "SELECT s FROM StateLa s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateLa.findByIndustrySpecificCodes", query = "SELECT s FROM StateLa s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateLa.findByAdsizeInYellowPages", query = "SELECT s FROM StateLa s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateLa.findByMetroArea", query = "SELECT s FROM StateLa s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateLa.findByRownum", query = "SELECT s FROM StateLa s WHERE s.rownum = :rownum")})
public class StateLa implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateLa)) {
            return false;
        }
        StateLa other = (StateLa) object;
    ...
    public String toString() {
        return "src.entities.StateLa[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateNc.findAll", query = "SELECT s FROM StateNc s"),
    @NamedQuery(name = "StateNc.findByCompanyName", query = "SELECT s FROM StateNc s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateNc.findByMailingAddress", query = "SELECT s FROM StateNc s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateNc.findByCity", query = "SELECT s FROM StateNc s WHERE s.city = :city"),
    @NamedQuery(name = "StateNc.findByState", query = "SELECT s FROM StateNc s WHERE s.state = :state"),
    @NamedQuery(name = "StateNc.findByZipCode", query = "SELECT s FROM StateNc s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateNc.findByMailingCarrierRoute", query = "SELECT s FROM StateNc s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateNc.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateNc s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateNc.findByStreetAddressCity", query = "SELECT s FROM StateNc s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateNc.findByStreetAddress", query = "SELECT s FROM StateNc s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateNc.findByStreetAddressZip", query = "SELECT s FROM StateNc s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateNc.findByStreetAddressZip4", query = "SELECT s FROM StateNc s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateNc.findByCounty", query = "SELECT s FROM StateNc s WHERE s.county = :county"),
    @NamedQuery(name = "StateNc.findByPhoneNumber", query = "SELECT s FROM StateNc s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateNc.findByFaxNumber", query = "SELECT s FROM StateNc s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateNc.findByWebAddress", query = "SELECT s FROM StateNc s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateNc.findByLastName", query = "SELECT s FROM StateNc s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateNc.findByFirstName", query = "SELECT s FROM StateNc s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateNc.findByContactTitle", query = "SELECT s FROM StateNc s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateNc.findByContactGender", query = "SELECT s FROM StateNc s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateNc.findByActualEmployeeSize", query = "SELECT s FROM StateNc s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateNc.findByEmployeeSizeRange", query = "SELECT s FROM StateNc s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateNc.findByActualSalesVolume", query = "SELECT s FROM StateNc s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateNc.findBySalesVolumeRange", query = "SELECT s FROM StateNc s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateNc.findByPrimarySic", query = "SELECT s FROM StateNc s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateNc.findByPrimarySicDescription", query = "SELECT s FROM StateNc s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateNc.findBySecondarySic1", query = "SELECT s FROM StateNc s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateNc.findBySecondarySicDescription1", query = "SELECT s FROM StateNc s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateNc.findBySecondarySic2", query = "SELECT s FROM StateNc s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateNc.findBySecondarySicDescription2", query = "SELECT s FROM StateNc s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateNc.findByCreditAlphaScore", query = "SELECT s FROM StateNc s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateNc.findByCreditNumericScore", query = "SELECT s FROM StateNc s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateNc.findByHeadquartersbranch", query = "SELECT s FROM StateNc s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateNc.findByOfficeSize", query = "SELECT s FROM StateNc s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateNc.findBySquareFootage", query = "SELECT s FROM StateNc s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateNc.findByFirmindividual", query = "SELECT s FROM StateNc s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateNc.findByPublicprivateFlag", query = "SELECT s FROM StateNc s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateNc.findByPcCode", query = "SELECT s FROM StateNc s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateNc.findByFranchisespecialty1", query = "SELECT s FROM StateNc s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateNc.findByFranchisespecialty2", query = "SELECT s FROM StateNc s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateNc.findByIndustrySpecificCodes", query = "SELECT s FROM StateNc s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateNc.findByAdsizeInYellowPages", query = "SELECT s FROM StateNc s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateNc.findByMetroArea", query = "SELECT s FROM StateNc s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateNc.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateNc s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateNc.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateNc s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateNc.findByRownum", query = "SELECT s FROM StateNc s WHERE s.rownum = :rownum")})
public class StateNc implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateNc)) {
            return false;
        }
        StateNc other = (StateNc) object;
    ...
    public String toString() {
        return "src.entities.StateNc[ rownum=" + rownum + " ]";
    }

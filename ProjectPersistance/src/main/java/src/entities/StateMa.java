...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateMa.findAll", query = "SELECT s FROM StateMa s"),
    @NamedQuery(name = "StateMa.findByCompanyName", query = "SELECT s FROM StateMa s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateMa.findByMailingAddress", query = "SELECT s FROM StateMa s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateMa.findByCity", query = "SELECT s FROM StateMa s WHERE s.city = :city"),
    @NamedQuery(name = "StateMa.findByState", query = "SELECT s FROM StateMa s WHERE s.state = :state"),
    @NamedQuery(name = "StateMa.findByZipCode", query = "SELECT s FROM StateMa s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateMa.findByMailingCarrierRoute", query = "SELECT s FROM StateMa s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateMa.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateMa s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateMa.findByStreetAddressCity", query = "SELECT s FROM StateMa s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateMa.findByStreetAddress", query = "SELECT s FROM StateMa s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateMa.findByStreetAddressZip", query = "SELECT s FROM StateMa s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateMa.findByStreetAddressZip4", query = "SELECT s FROM StateMa s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateMa.findByCounty", query = "SELECT s FROM StateMa s WHERE s.county = :county"),
    @NamedQuery(name = "StateMa.findByPhoneNumber", query = "SELECT s FROM StateMa s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateMa.findByFaxNumber", query = "SELECT s FROM StateMa s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateMa.findByWebAddress", query = "SELECT s FROM StateMa s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateMa.findByLastName", query = "SELECT s FROM StateMa s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateMa.findByFirstName", query = "SELECT s FROM StateMa s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateMa.findByContactTitle", query = "SELECT s FROM StateMa s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateMa.findByContactGender", query = "SELECT s FROM StateMa s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateMa.findByActualEmployeeSize", query = "SELECT s FROM StateMa s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateMa.findByEmployeeSizeRange", query = "SELECT s FROM StateMa s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateMa.findByActualSalesVolume", query = "SELECT s FROM StateMa s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateMa.findBySalesVolumeRange", query = "SELECT s FROM StateMa s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateMa.findByPrimarySic", query = "SELECT s FROM StateMa s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateMa.findByPrimarySicDescription", query = "SELECT s FROM StateMa s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateMa.findBySecondarySic1", query = "SELECT s FROM StateMa s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateMa.findBySecondarySicDescription1", query = "SELECT s FROM StateMa s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateMa.findBySecondarySic2", query = "SELECT s FROM StateMa s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateMa.findBySecondarySicDescription2", query = "SELECT s FROM StateMa s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateMa.findByCreditAlphaScore", query = "SELECT s FROM StateMa s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateMa.findByCreditNumericScore", query = "SELECT s FROM StateMa s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateMa.findByHeadquartersbranch", query = "SELECT s FROM StateMa s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateMa.findByOfficeSize", query = "SELECT s FROM StateMa s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateMa.findBySquareFootage", query = "SELECT s FROM StateMa s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateMa.findByFirmindividual", query = "SELECT s FROM StateMa s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateMa.findByPublicprivateFlag", query = "SELECT s FROM StateMa s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateMa.findByPcCode", query = "SELECT s FROM StateMa s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateMa.findByFranchisespecialty1", query = "SELECT s FROM StateMa s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateMa.findByFranchisespecialty2", query = "SELECT s FROM StateMa s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateMa.findByIndustrySpecificCodes", query = "SELECT s FROM StateMa s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateMa.findByAdsizeInYellowPages", query = "SELECT s FROM StateMa s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateMa.findByMetroArea", query = "SELECT s FROM StateMa s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateMa.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateMa s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateMa.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateMa s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateMa.findByRownum", query = "SELECT s FROM StateMa s WHERE s.rownum = :rownum")})
public class StateMa implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateMa)) {
            return false;
        }
        StateMa other = (StateMa) object;
    ...
    public String toString() {
        return "src.entities.StateMa[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateDe.findAll", query = "SELECT s FROM StateDe s"),
    @NamedQuery(name = "StateDe.findByCompanyName", query = "SELECT s FROM StateDe s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateDe.findByMailingAddress", query = "SELECT s FROM StateDe s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateDe.findByCity", query = "SELECT s FROM StateDe s WHERE s.city = :city"),
    @NamedQuery(name = "StateDe.findByState", query = "SELECT s FROM StateDe s WHERE s.state = :state"),
    @NamedQuery(name = "StateDe.findByZipCode", query = "SELECT s FROM StateDe s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateDe.findByMailingCarrierRoute", query = "SELECT s FROM StateDe s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateDe.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateDe s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateDe.findByStreetAddressCity", query = "SELECT s FROM StateDe s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateDe.findByStreetAddress", query = "SELECT s FROM StateDe s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateDe.findByStreetAddressZip", query = "SELECT s FROM StateDe s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateDe.findByStreetAddressZip4", query = "SELECT s FROM StateDe s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateDe.findByCounty", query = "SELECT s FROM StateDe s WHERE s.county = :county"),
    @NamedQuery(name = "StateDe.findByPhoneNumber", query = "SELECT s FROM StateDe s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateDe.findByFaxNumber", query = "SELECT s FROM StateDe s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateDe.findByWebAddress", query = "SELECT s FROM StateDe s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateDe.findByLastName", query = "SELECT s FROM StateDe s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateDe.findByFirstName", query = "SELECT s FROM StateDe s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateDe.findByContactTitle", query = "SELECT s FROM StateDe s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateDe.findByContactGender", query = "SELECT s FROM StateDe s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateDe.findByActualEmployeeSize", query = "SELECT s FROM StateDe s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateDe.findByEmployeeSizeRange", query = "SELECT s FROM StateDe s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateDe.findByActualSalesVolume", query = "SELECT s FROM StateDe s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateDe.findBySalesVolumeRange", query = "SELECT s FROM StateDe s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateDe.findByPrimarySic", query = "SELECT s FROM StateDe s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateDe.findByPrimarySicDescription", query = "SELECT s FROM StateDe s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateDe.findBySecondarySic1", query = "SELECT s FROM StateDe s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateDe.findBySecondarySicDescription1", query = "SELECT s FROM StateDe s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateDe.findBySecondarySic2", query = "SELECT s FROM StateDe s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateDe.findBySecondarySicDescription2", query = "SELECT s FROM StateDe s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateDe.findByCreditAlphaScore", query = "SELECT s FROM StateDe s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateDe.findByCreditNumericScore", query = "SELECT s FROM StateDe s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateDe.findByHeadquartersbranch", query = "SELECT s FROM StateDe s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateDe.findByOfficeSize", query = "SELECT s FROM StateDe s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateDe.findBySquareFootage", query = "SELECT s FROM StateDe s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateDe.findByFirmindividual", query = "SELECT s FROM StateDe s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateDe.findByPublicprivateFlag", query = "SELECT s FROM StateDe s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateDe.findByPcCode", query = "SELECT s FROM StateDe s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateDe.findByFranchisespecialty1", query = "SELECT s FROM StateDe s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateDe.findByFranchisespecialty2", query = "SELECT s FROM StateDe s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateDe.findByIndustrySpecificCodes", query = "SELECT s FROM StateDe s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateDe.findByAdsizeInYellowPages", query = "SELECT s FROM StateDe s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateDe.findByMetroArea", query = "SELECT s FROM StateDe s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateDe.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateDe s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateDe.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateDe s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateDe.findByRownum", query = "SELECT s FROM StateDe s WHERE s.rownum = :rownum")})
public class StateDe implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateDe)) {
            return false;
        }
        StateDe other = (StateDe) object;
    ...
    public String toString() {
        return "src.entities.StateDe[ rownum=" + rownum + " ]";
    }

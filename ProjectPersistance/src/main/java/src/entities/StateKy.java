...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateKy.findAll", query = "SELECT s FROM StateKy s"),
    @NamedQuery(name = "StateKy.findByCompanyName", query = "SELECT s FROM StateKy s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateKy.findByMailingAddress", query = "SELECT s FROM StateKy s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateKy.findByCity", query = "SELECT s FROM StateKy s WHERE s.city = :city"),
    @NamedQuery(name = "StateKy.findByState", query = "SELECT s FROM StateKy s WHERE s.state = :state"),
    @NamedQuery(name = "StateKy.findByZipCode", query = "SELECT s FROM StateKy s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateKy.findByMailingCarrierRoute", query = "SELECT s FROM StateKy s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateKy.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateKy s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateKy.findByStreetAddress", query = "SELECT s FROM StateKy s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateKy.findByStreetAddressCity", query = "SELECT s FROM StateKy s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateKy.findByStreetAddressState", query = "SELECT s FROM StateKy s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateKy.findByStreetAddressZip", query = "SELECT s FROM StateKy s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateKy.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateKy s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateKy.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateKy s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateKy.findByCounty", query = "SELECT s FROM StateKy s WHERE s.county = :county"),
    @NamedQuery(name = "StateKy.findByPhoneNumber", query = "SELECT s FROM StateKy s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateKy.findByFaxNumber", query = "SELECT s FROM StateKy s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateKy.findByWebAddress", query = "SELECT s FROM StateKy s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateKy.findByLastName", query = "SELECT s FROM StateKy s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateKy.findByFirstName", query = "SELECT s FROM StateKy s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateKy.findByContactTitle", query = "SELECT s FROM StateKy s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateKy.findByContactGender", query = "SELECT s FROM StateKy s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateKy.findByActualEmployeeSize", query = "SELECT s FROM StateKy s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateKy.findByEmployeeSizeRange", query = "SELECT s FROM StateKy s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateKy.findByActualSalesVolume", query = "SELECT s FROM StateKy s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateKy.findBySalesVolumeRange", query = "SELECT s FROM StateKy s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateKy.findByPrimarySic", query = "SELECT s FROM StateKy s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateKy.findByPrimarySicDescription", query = "SELECT s FROM StateKy s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateKy.findBySecondarySic1", query = "SELECT s FROM StateKy s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateKy.findBySecondarySicDescription1", query = "SELECT s FROM StateKy s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateKy.findBySecondarySic2", query = "SELECT s FROM StateKy s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateKy.findBySecondarySicDescription2", query = "SELECT s FROM StateKy s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateKy.findByCreditAlphaScore", query = "SELECT s FROM StateKy s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateKy.findByCreditNumericScore", query = "SELECT s FROM StateKy s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateKy.findByHeadquartersbranch", query = "SELECT s FROM StateKy s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateKy.findByOfficeSize", query = "SELECT s FROM StateKy s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateKy.findBySquareFootage", query = "SELECT s FROM StateKy s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateKy.findByFirmindividual", query = "SELECT s FROM StateKy s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateKy.findByPublicprivateFlag", query = "SELECT s FROM StateKy s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateKy.findByPcCode", query = "SELECT s FROM StateKy s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateKy.findByFranchisespecialty1", query = "SELECT s FROM StateKy s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateKy.findByFranchisespecialty2", query = "SELECT s FROM StateKy s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateKy.findByIndustrySpecificCodes", query = "SELECT s FROM StateKy s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateKy.findByAdsizeInYellowPages", query = "SELECT s FROM StateKy s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateKy.findByMetroArea", query = "SELECT s FROM StateKy s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateKy.findByRownum", query = "SELECT s FROM StateKy s WHERE s.rownum = :rownum")})
public class StateKy implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateKy)) {
            return false;
        }
        StateKy other = (StateKy) object;
    ...
    public String toString() {
        return "src.entities.StateKy[ rownum=" + rownum + " ]";
    }

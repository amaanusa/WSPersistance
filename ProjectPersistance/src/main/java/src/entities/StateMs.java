...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateMs.findAll", query = "SELECT s FROM StateMs s"),
    @NamedQuery(name = "StateMs.findByCompanyName", query = "SELECT s FROM StateMs s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateMs.findByMailingAddress", query = "SELECT s FROM StateMs s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateMs.findByCity", query = "SELECT s FROM StateMs s WHERE s.city = :city"),
    @NamedQuery(name = "StateMs.findByState", query = "SELECT s FROM StateMs s WHERE s.state = :state"),
    @NamedQuery(name = "StateMs.findByZipCode", query = "SELECT s FROM StateMs s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateMs.findByMailingCarrierRoute", query = "SELECT s FROM StateMs s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateMs.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateMs s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateMs.findByStreetAddressCity", query = "SELECT s FROM StateMs s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateMs.findByStreetAddress", query = "SELECT s FROM StateMs s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateMs.findByStreetAddressZip", query = "SELECT s FROM StateMs s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateMs.findByStreetAddressZip4", query = "SELECT s FROM StateMs s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateMs.findByCounty", query = "SELECT s FROM StateMs s WHERE s.county = :county"),
    @NamedQuery(name = "StateMs.findByPhoneNumber", query = "SELECT s FROM StateMs s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateMs.findByFaxNumber", query = "SELECT s FROM StateMs s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateMs.findByWebAddress", query = "SELECT s FROM StateMs s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateMs.findByLastName", query = "SELECT s FROM StateMs s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateMs.findByFirstName", query = "SELECT s FROM StateMs s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateMs.findByContactTitle", query = "SELECT s FROM StateMs s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateMs.findByContactGender", query = "SELECT s FROM StateMs s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateMs.findByActualEmployeeSize", query = "SELECT s FROM StateMs s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateMs.findByEmployeeSizeRange", query = "SELECT s FROM StateMs s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateMs.findByActualSalesVolume", query = "SELECT s FROM StateMs s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateMs.findBySalesVolumeRange", query = "SELECT s FROM StateMs s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateMs.findByPrimarySic", query = "SELECT s FROM StateMs s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateMs.findByPrimarySicDescription", query = "SELECT s FROM StateMs s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateMs.findBySecondarySic1", query = "SELECT s FROM StateMs s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateMs.findBySecondarySicDescription1", query = "SELECT s FROM StateMs s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateMs.findBySecondarySic2", query = "SELECT s FROM StateMs s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateMs.findBySecondarySicDescription2", query = "SELECT s FROM StateMs s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateMs.findByCreditAlphaScore", query = "SELECT s FROM StateMs s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateMs.findByCreditNumericScore", query = "SELECT s FROM StateMs s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateMs.findByHeadquartersbranch", query = "SELECT s FROM StateMs s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateMs.findByOfficeSize", query = "SELECT s FROM StateMs s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateMs.findBySquareFootage", query = "SELECT s FROM StateMs s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateMs.findByFirmindividual", query = "SELECT s FROM StateMs s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateMs.findByPublicprivateFlag", query = "SELECT s FROM StateMs s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateMs.findByPcCode", query = "SELECT s FROM StateMs s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateMs.findByFranchisespecialty1", query = "SELECT s FROM StateMs s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateMs.findByFranchisespecialty2", query = "SELECT s FROM StateMs s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateMs.findByIndustrySpecificCodes", query = "SELECT s FROM StateMs s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateMs.findByAdsizeInYellowPages", query = "SELECT s FROM StateMs s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateMs.findByMetroArea", query = "SELECT s FROM StateMs s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateMs.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateMs s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateMs.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateMs s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateMs.findByRownum", query = "SELECT s FROM StateMs s WHERE s.rownum = :rownum")})
public class StateMs implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateMs)) {
            return false;
        }
        StateMs other = (StateMs) object;
    ...
    public String toString() {
        return "src.entities.StateMs[ rownum=" + rownum + " ]";
    }

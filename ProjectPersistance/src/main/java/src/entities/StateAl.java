...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateAl.findAll", query = "SELECT s FROM StateAl s"),
    @NamedQuery(name = "StateAl.findByCompanyName", query = "SELECT s FROM StateAl s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateAl.findByMailingAddress", query = "SELECT s FROM StateAl s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateAl.findByCity", query = "SELECT s FROM StateAl s WHERE s.city = :city"),
    @NamedQuery(name = "StateAl.findByState", query = "SELECT s FROM StateAl s WHERE s.state = :state"),
    @NamedQuery(name = "StateAl.findByZipCode", query = "SELECT s FROM StateAl s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateAl.findByMailingCarrierRoute", query = "SELECT s FROM StateAl s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateAl.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateAl s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateAl.findByStreetAddress", query = "SELECT s FROM StateAl s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateAl.findByStreetAddressCity", query = "SELECT s FROM StateAl s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateAl.findByStreetAddressState", query = "SELECT s FROM StateAl s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateAl.findByStreetAddressZip", query = "SELECT s FROM StateAl s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateAl.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateAl s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateAl.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateAl s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateAl.findByCounty", query = "SELECT s FROM StateAl s WHERE s.county = :county"),
    @NamedQuery(name = "StateAl.findByPhoneNumber", query = "SELECT s FROM StateAl s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateAl.findByFaxNumber", query = "SELECT s FROM StateAl s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateAl.findByWebAddress", query = "SELECT s FROM StateAl s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateAl.findByLastName", query = "SELECT s FROM StateAl s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateAl.findByFirstName", query = "SELECT s FROM StateAl s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateAl.findByContactTitle", query = "SELECT s FROM StateAl s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateAl.findByContactGender", query = "SELECT s FROM StateAl s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateAl.findByActualEmployeeSize", query = "SELECT s FROM StateAl s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateAl.findByEmployeeSizeRange", query = "SELECT s FROM StateAl s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateAl.findByActualSalesVolume", query = "SELECT s FROM StateAl s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateAl.findBySalesVolumeRange", query = "SELECT s FROM StateAl s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateAl.findByPrimarySic", query = "SELECT s FROM StateAl s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateAl.findByPrimarySicDescription", query = "SELECT s FROM StateAl s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateAl.findBySecondarySic1", query = "SELECT s FROM StateAl s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateAl.findBySecondarySicDescription1", query = "SELECT s FROM StateAl s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateAl.findBySecondarySic2", query = "SELECT s FROM StateAl s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateAl.findBySecondarySicDescription2", query = "SELECT s FROM StateAl s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateAl.findByCreditAlphaScore", query = "SELECT s FROM StateAl s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateAl.findByCreditNumericScore", query = "SELECT s FROM StateAl s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateAl.findByHeadquartersbranch", query = "SELECT s FROM StateAl s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateAl.findByOfficeSize", query = "SELECT s FROM StateAl s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateAl.findBySquareFootage", query = "SELECT s FROM StateAl s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateAl.findByFirmindividual", query = "SELECT s FROM StateAl s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateAl.findByPublicprivateFlag", query = "SELECT s FROM StateAl s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateAl.findByPcCode", query = "SELECT s FROM StateAl s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateAl.findByFranchisespecialty1", query = "SELECT s FROM StateAl s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateAl.findByFranchisespecialty2", query = "SELECT s FROM StateAl s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateAl.findByIndustrySpecificCodes", query = "SELECT s FROM StateAl s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateAl.findByAdsizeInYellowPages", query = "SELECT s FROM StateAl s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateAl.findByMetroArea", query = "SELECT s FROM StateAl s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateAl.findByRownum", query = "SELECT s FROM StateAl s WHERE s.rownum = :rownum")})
public class StateAl implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateAl)) {
            return false;
        }
        StateAl other = (StateAl) object;
    ...
    public String toString() {
        return "src.entities.StateAl[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateIa.findAll", query = "SELECT s FROM StateIa s"),
    @NamedQuery(name = "StateIa.findByCompanyName", query = "SELECT s FROM StateIa s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateIa.findByMailingAddress", query = "SELECT s FROM StateIa s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateIa.findByCity", query = "SELECT s FROM StateIa s WHERE s.city = :city"),
    @NamedQuery(name = "StateIa.findByState", query = "SELECT s FROM StateIa s WHERE s.state = :state"),
    @NamedQuery(name = "StateIa.findByZipCode", query = "SELECT s FROM StateIa s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateIa.findByMailingCarrierRoute", query = "SELECT s FROM StateIa s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateIa.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateIa s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateIa.findByStreetAddress", query = "SELECT s FROM StateIa s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateIa.findByStreetAddressCity", query = "SELECT s FROM StateIa s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateIa.findByStreetAddressState", query = "SELECT s FROM StateIa s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateIa.findByStreetAddressZip", query = "SELECT s FROM StateIa s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateIa.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateIa s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateIa.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateIa s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateIa.findByCounty", query = "SELECT s FROM StateIa s WHERE s.county = :county"),
    @NamedQuery(name = "StateIa.findByPhoneNumber", query = "SELECT s FROM StateIa s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateIa.findByFaxNumber", query = "SELECT s FROM StateIa s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateIa.findByWebAddress", query = "SELECT s FROM StateIa s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateIa.findByLastName", query = "SELECT s FROM StateIa s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateIa.findByFirstName", query = "SELECT s FROM StateIa s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateIa.findByContactTitle", query = "SELECT s FROM StateIa s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateIa.findByContactGender", query = "SELECT s FROM StateIa s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateIa.findByActualEmployeeSize", query = "SELECT s FROM StateIa s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateIa.findByEmployeeSizeRange", query = "SELECT s FROM StateIa s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateIa.findByActualSalesVolume", query = "SELECT s FROM StateIa s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateIa.findBySalesVolumeRange", query = "SELECT s FROM StateIa s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateIa.findByPrimarySic", query = "SELECT s FROM StateIa s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateIa.findByPrimarySicDescription", query = "SELECT s FROM StateIa s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateIa.findBySecondarySic1", query = "SELECT s FROM StateIa s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateIa.findBySecondarySicDescription1", query = "SELECT s FROM StateIa s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateIa.findBySecondarySic2", query = "SELECT s FROM StateIa s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateIa.findBySecondarySicDescription2", query = "SELECT s FROM StateIa s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateIa.findByCreditAlphaScore", query = "SELECT s FROM StateIa s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateIa.findByCreditNumericScore", query = "SELECT s FROM StateIa s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateIa.findByHeadquartersbranch", query = "SELECT s FROM StateIa s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateIa.findByOfficeSize", query = "SELECT s FROM StateIa s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateIa.findBySquareFootage", query = "SELECT s FROM StateIa s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateIa.findByFirmindividual", query = "SELECT s FROM StateIa s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateIa.findByPublicprivateFlag", query = "SELECT s FROM StateIa s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateIa.findByPcCode", query = "SELECT s FROM StateIa s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateIa.findByFranchisespecialty1", query = "SELECT s FROM StateIa s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateIa.findByFranchisespecialty2", query = "SELECT s FROM StateIa s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateIa.findByIndustrySpecificCodes", query = "SELECT s FROM StateIa s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateIa.findByAdsizeInYellowPages", query = "SELECT s FROM StateIa s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateIa.findByMetroArea", query = "SELECT s FROM StateIa s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateIa.findByRownum", query = "SELECT s FROM StateIa s WHERE s.rownum = :rownum")})
public class StateIa implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateIa)) {
            return false;
        }
        StateIa other = (StateIa) object;
    ...
    public String toString() {
        return "src.entities.StateIa[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateFl.findAll", query = "SELECT s FROM StateFl s"),
    @NamedQuery(name = "StateFl.findByCompanyName", query = "SELECT s FROM StateFl s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateFl.findByMailingAddress", query = "SELECT s FROM StateFl s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateFl.findByCity", query = "SELECT s FROM StateFl s WHERE s.city = :city"),
    @NamedQuery(name = "StateFl.findByState", query = "SELECT s FROM StateFl s WHERE s.state = :state"),
    @NamedQuery(name = "StateFl.findByZipCode", query = "SELECT s FROM StateFl s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateFl.findByMailingCarrierRoute", query = "SELECT s FROM StateFl s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateFl.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateFl s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateFl.findByStreetAddressCity", query = "SELECT s FROM StateFl s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateFl.findByStreetAddress", query = "SELECT s FROM StateFl s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateFl.findByStreetAddressZip", query = "SELECT s FROM StateFl s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateFl.findByStreetAddressZip4", query = "SELECT s FROM StateFl s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateFl.findByCounty", query = "SELECT s FROM StateFl s WHERE s.county = :county"),
    @NamedQuery(name = "StateFl.findByPhoneNumber", query = "SELECT s FROM StateFl s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateFl.findByFaxNumber", query = "SELECT s FROM StateFl s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateFl.findByWebAddress", query = "SELECT s FROM StateFl s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateFl.findByLastName", query = "SELECT s FROM StateFl s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateFl.findByFirstName", query = "SELECT s FROM StateFl s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateFl.findByContactTitle", query = "SELECT s FROM StateFl s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateFl.findByContactGender", query = "SELECT s FROM StateFl s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateFl.findByActualEmployeeSize", query = "SELECT s FROM StateFl s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateFl.findByEmployeeSizeRange", query = "SELECT s FROM StateFl s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateFl.findByActualSalesVolume", query = "SELECT s FROM StateFl s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateFl.findBySalesVolumeRange", query = "SELECT s FROM StateFl s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateFl.findByPrimarySic", query = "SELECT s FROM StateFl s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateFl.findByPrimarySicDescription", query = "SELECT s FROM StateFl s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateFl.findBySecondarySic1", query = "SELECT s FROM StateFl s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateFl.findBySecondarySicDescription1", query = "SELECT s FROM StateFl s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateFl.findBySecondarySic2", query = "SELECT s FROM StateFl s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateFl.findBySecondarySicDescription2", query = "SELECT s FROM StateFl s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateFl.findByCreditAlphaScore", query = "SELECT s FROM StateFl s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateFl.findByCreditNumericScore", query = "SELECT s FROM StateFl s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateFl.findByHeadquartersbranch", query = "SELECT s FROM StateFl s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateFl.findByOfficeSize", query = "SELECT s FROM StateFl s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateFl.findBySquareFootage", query = "SELECT s FROM StateFl s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateFl.findByFirmindividual", query = "SELECT s FROM StateFl s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateFl.findByPublicprivateFlag", query = "SELECT s FROM StateFl s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateFl.findByPcCode", query = "SELECT s FROM StateFl s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateFl.findByFranchisespecialty1", query = "SELECT s FROM StateFl s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateFl.findByFranchisespecialty2", query = "SELECT s FROM StateFl s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateFl.findByIndustrySpecificCodes", query = "SELECT s FROM StateFl s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateFl.findByAdsizeInYellowPages", query = "SELECT s FROM StateFl s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateFl.findByMetroArea", query = "SELECT s FROM StateFl s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateFl.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateFl s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateFl.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateFl s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateFl.findByRownum", query = "SELECT s FROM StateFl s WHERE s.rownum = :rownum")})
public class StateFl implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateFl)) {
            return false;
        }
        StateFl other = (StateFl) object;
    ...
    public String toString() {
        return "src.entities.StateFl[ rownum=" + rownum + " ]";
    }

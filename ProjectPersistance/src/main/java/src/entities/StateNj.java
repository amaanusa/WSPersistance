...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateNj.findAll", query = "SELECT s FROM StateNj s"),
    @NamedQuery(name = "StateNj.findByCompanyName", query = "SELECT s FROM StateNj s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateNj.findByMailingAddress", query = "SELECT s FROM StateNj s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateNj.findByCity", query = "SELECT s FROM StateNj s WHERE s.city = :city"),
    @NamedQuery(name = "StateNj.findByState", query = "SELECT s FROM StateNj s WHERE s.state = :state"),
    @NamedQuery(name = "StateNj.findByZipCode", query = "SELECT s FROM StateNj s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateNj.findByMailingCarrierRoute", query = "SELECT s FROM StateNj s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateNj.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateNj s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateNj.findByStreetAddressCity", query = "SELECT s FROM StateNj s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateNj.findByStreetAddress", query = "SELECT s FROM StateNj s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateNj.findByStreetAddressZip", query = "SELECT s FROM StateNj s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateNj.findByStreetAddressZip4", query = "SELECT s FROM StateNj s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateNj.findByCounty", query = "SELECT s FROM StateNj s WHERE s.county = :county"),
    @NamedQuery(name = "StateNj.findByPhoneNumber", query = "SELECT s FROM StateNj s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateNj.findByFaxNumber", query = "SELECT s FROM StateNj s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateNj.findByWebAddress", query = "SELECT s FROM StateNj s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateNj.findByLastName", query = "SELECT s FROM StateNj s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateNj.findByFirstName", query = "SELECT s FROM StateNj s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateNj.findByContactTitle", query = "SELECT s FROM StateNj s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateNj.findByContactGender", query = "SELECT s FROM StateNj s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateNj.findByActualEmployeeSize", query = "SELECT s FROM StateNj s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateNj.findByEmployeeSizeRange", query = "SELECT s FROM StateNj s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateNj.findByActualSalesVolume", query = "SELECT s FROM StateNj s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateNj.findBySalesVolumeRange", query = "SELECT s FROM StateNj s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateNj.findByPrimarySic", query = "SELECT s FROM StateNj s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateNj.findByPrimarySicDescription", query = "SELECT s FROM StateNj s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateNj.findBySecondarySic1", query = "SELECT s FROM StateNj s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateNj.findBySecondarySicDescription1", query = "SELECT s FROM StateNj s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateNj.findBySecondarySic2", query = "SELECT s FROM StateNj s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateNj.findBySecondarySicDescription2", query = "SELECT s FROM StateNj s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateNj.findByCreditAlphaScore", query = "SELECT s FROM StateNj s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateNj.findByCreditNumericScore", query = "SELECT s FROM StateNj s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateNj.findByHeadquartersbranch", query = "SELECT s FROM StateNj s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateNj.findByOfficeSize", query = "SELECT s FROM StateNj s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateNj.findBySquareFootage", query = "SELECT s FROM StateNj s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateNj.findByFirmindividual", query = "SELECT s FROM StateNj s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateNj.findByPublicprivateFlag", query = "SELECT s FROM StateNj s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateNj.findByPcCode", query = "SELECT s FROM StateNj s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateNj.findByFranchisespecialty1", query = "SELECT s FROM StateNj s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateNj.findByFranchisespecialty2", query = "SELECT s FROM StateNj s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateNj.findByIndustrySpecificCodes", query = "SELECT s FROM StateNj s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateNj.findByAdsizeInYellowPages", query = "SELECT s FROM StateNj s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateNj.findByMetroArea", query = "SELECT s FROM StateNj s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateNj.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateNj s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateNj.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateNj s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateNj.findByRownum", query = "SELECT s FROM StateNj s WHERE s.rownum = :rownum")})
public class StateNj implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateNj)) {
            return false;
        }
        StateNj other = (StateNj) object;
    ...
    public String toString() {
        return "src.entities.StateNj[ rownum=" + rownum + " ]";
    }

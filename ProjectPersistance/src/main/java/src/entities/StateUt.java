...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateUt.findAll", query = "SELECT s FROM StateUt s"),
    @NamedQuery(name = "StateUt.findByCompanyName", query = "SELECT s FROM StateUt s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateUt.findByMailingAddress", query = "SELECT s FROM StateUt s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateUt.findByCity", query = "SELECT s FROM StateUt s WHERE s.city = :city"),
    @NamedQuery(name = "StateUt.findByState", query = "SELECT s FROM StateUt s WHERE s.state = :state"),
    @NamedQuery(name = "StateUt.findByZipCode", query = "SELECT s FROM StateUt s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateUt.findByMailingCarrierRoute", query = "SELECT s FROM StateUt s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateUt.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateUt s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateUt.findByStreetAddress", query = "SELECT s FROM StateUt s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateUt.findByStreetAddressCity", query = "SELECT s FROM StateUt s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateUt.findByStreetAddressState", query = "SELECT s FROM StateUt s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateUt.findByStreetAddressZip", query = "SELECT s FROM StateUt s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateUt.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateUt s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateUt.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateUt s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateUt.findByCounty", query = "SELECT s FROM StateUt s WHERE s.county = :county"),
    @NamedQuery(name = "StateUt.findByPhoneNumber", query = "SELECT s FROM StateUt s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateUt.findByFaxNumber", query = "SELECT s FROM StateUt s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateUt.findByWebAddress", query = "SELECT s FROM StateUt s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateUt.findByLastName", query = "SELECT s FROM StateUt s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateUt.findByFirstName", query = "SELECT s FROM StateUt s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateUt.findByContactTitle", query = "SELECT s FROM StateUt s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateUt.findByContactGender", query = "SELECT s FROM StateUt s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateUt.findByActualEmployeeSize", query = "SELECT s FROM StateUt s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateUt.findByEmployeeSizeRange", query = "SELECT s FROM StateUt s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateUt.findByActualSalesVolume", query = "SELECT s FROM StateUt s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateUt.findBySalesVolumeRange", query = "SELECT s FROM StateUt s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateUt.findByPrimarySic", query = "SELECT s FROM StateUt s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateUt.findByPrimarySicDescription", query = "SELECT s FROM StateUt s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateUt.findBySecondarySic1", query = "SELECT s FROM StateUt s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateUt.findBySecondarySicDescription1", query = "SELECT s FROM StateUt s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateUt.findBySecondarySic2", query = "SELECT s FROM StateUt s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateUt.findBySecondarySicDescription2", query = "SELECT s FROM StateUt s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateUt.findByCreditAlphaScore", query = "SELECT s FROM StateUt s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateUt.findByCreditNumericScore", query = "SELECT s FROM StateUt s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateUt.findByHeadquartersbranch", query = "SELECT s FROM StateUt s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateUt.findByOfficeSize", query = "SELECT s FROM StateUt s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateUt.findBySquareFootage", query = "SELECT s FROM StateUt s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateUt.findByFirmindividual", query = "SELECT s FROM StateUt s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateUt.findByPublicprivateFlag", query = "SELECT s FROM StateUt s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateUt.findByPcCode", query = "SELECT s FROM StateUt s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateUt.findByFranchisespecialty1", query = "SELECT s FROM StateUt s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateUt.findByFranchisespecialty2", query = "SELECT s FROM StateUt s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateUt.findByIndustrySpecificCodes", query = "SELECT s FROM StateUt s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateUt.findByAdsizeInYellowPages", query = "SELECT s FROM StateUt s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateUt.findByMetroArea", query = "SELECT s FROM StateUt s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateUt.findByRownum", query = "SELECT s FROM StateUt s WHERE s.rownum = :rownum")})
public class StateUt implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateUt)) {
            return false;
        }
        StateUt other = (StateUt) object;
    ...
    public String toString() {
        return "src.entities.StateUt[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateAr.findAll", query = "SELECT s FROM StateAr s"),
    @NamedQuery(name = "StateAr.findByCompanyName", query = "SELECT s FROM StateAr s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateAr.findByMailingAddress", query = "SELECT s FROM StateAr s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateAr.findByCity", query = "SELECT s FROM StateAr s WHERE s.city = :city"),
    @NamedQuery(name = "StateAr.findByState", query = "SELECT s FROM StateAr s WHERE s.state = :state"),
    @NamedQuery(name = "StateAr.findByZipCode", query = "SELECT s FROM StateAr s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateAr.findByMailingCarrierRoute", query = "SELECT s FROM StateAr s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateAr.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateAr s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateAr.findByStreetAddressCity", query = "SELECT s FROM StateAr s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateAr.findByStreetAddress", query = "SELECT s FROM StateAr s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateAr.findByStreetAddressZip", query = "SELECT s FROM StateAr s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateAr.findByStreetAddressZip4", query = "SELECT s FROM StateAr s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateAr.findByCounty", query = "SELECT s FROM StateAr s WHERE s.county = :county"),
    @NamedQuery(name = "StateAr.findByPhoneNumber", query = "SELECT s FROM StateAr s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateAr.findByFaxNumber", query = "SELECT s FROM StateAr s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateAr.findByWebAddress", query = "SELECT s FROM StateAr s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateAr.findByLastName", query = "SELECT s FROM StateAr s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateAr.findByFirstName", query = "SELECT s FROM StateAr s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateAr.findByContactTitle", query = "SELECT s FROM StateAr s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateAr.findByContactGender", query = "SELECT s FROM StateAr s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateAr.findByActualEmployeeSize", query = "SELECT s FROM StateAr s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateAr.findByEmployeeSizeRange", query = "SELECT s FROM StateAr s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateAr.findByActualSalesVolume", query = "SELECT s FROM StateAr s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateAr.findBySalesVolumeRange", query = "SELECT s FROM StateAr s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateAr.findByPrimarySic", query = "SELECT s FROM StateAr s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateAr.findByPrimarySicDescription", query = "SELECT s FROM StateAr s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateAr.findBySecondarySic1", query = "SELECT s FROM StateAr s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateAr.findBySecondarySicDescription1", query = "SELECT s FROM StateAr s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateAr.findBySecondarySic2", query = "SELECT s FROM StateAr s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateAr.findBySecondarySicDescription2", query = "SELECT s FROM StateAr s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateAr.findByCreditAlphaScore", query = "SELECT s FROM StateAr s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateAr.findByCreditNumericScore", query = "SELECT s FROM StateAr s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateAr.findByHeadquartersbranch", query = "SELECT s FROM StateAr s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateAr.findByOfficeSize", query = "SELECT s FROM StateAr s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateAr.findBySquareFootage", query = "SELECT s FROM StateAr s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateAr.findByFirmindividual", query = "SELECT s FROM StateAr s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateAr.findByPublicprivateFlag", query = "SELECT s FROM StateAr s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateAr.findByPcCode", query = "SELECT s FROM StateAr s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateAr.findByFranchisespecialty1", query = "SELECT s FROM StateAr s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateAr.findByFranchisespecialty2", query = "SELECT s FROM StateAr s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateAr.findByIndustrySpecificCodes", query = "SELECT s FROM StateAr s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateAr.findByAdsizeInYellowPages", query = "SELECT s FROM StateAr s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateAr.findByMetroArea", query = "SELECT s FROM StateAr s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateAr.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateAr s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateAr.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateAr s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateAr.findByRownum", query = "SELECT s FROM StateAr s WHERE s.rownum = :rownum")})
public class StateAr implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateAr)) {
            return false;
        }
        StateAr other = (StateAr) object;
    ...
    public String toString() {
        return "src.entities.StateAr[ rownum=" + rownum + " ]";
    }

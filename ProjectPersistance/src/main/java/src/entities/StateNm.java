...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateNm.findAll", query = "SELECT s FROM StateNm s"),
    @NamedQuery(name = "StateNm.findByCompanyName", query = "SELECT s FROM StateNm s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateNm.findByMailingAddress", query = "SELECT s FROM StateNm s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateNm.findByCity", query = "SELECT s FROM StateNm s WHERE s.city = :city"),
    @NamedQuery(name = "StateNm.findByState", query = "SELECT s FROM StateNm s WHERE s.state = :state"),
    @NamedQuery(name = "StateNm.findByZipCode", query = "SELECT s FROM StateNm s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateNm.findByMailingCarrierRoute", query = "SELECT s FROM StateNm s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateNm.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateNm s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateNm.findByStreetAddressCity", query = "SELECT s FROM StateNm s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateNm.findByStreetAddress", query = "SELECT s FROM StateNm s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateNm.findByStreetAddressZip", query = "SELECT s FROM StateNm s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateNm.findByStreetAddressZip4", query = "SELECT s FROM StateNm s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateNm.findByCounty", query = "SELECT s FROM StateNm s WHERE s.county = :county"),
    @NamedQuery(name = "StateNm.findByPhoneNumber", query = "SELECT s FROM StateNm s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateNm.findByFaxNumber", query = "SELECT s FROM StateNm s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateNm.findByWebAddress", query = "SELECT s FROM StateNm s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateNm.findByLastName", query = "SELECT s FROM StateNm s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateNm.findByFirstName", query = "SELECT s FROM StateNm s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateNm.findByContactTitle", query = "SELECT s FROM StateNm s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateNm.findByContactGender", query = "SELECT s FROM StateNm s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateNm.findByActualEmployeeSize", query = "SELECT s FROM StateNm s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateNm.findByEmployeeSizeRange", query = "SELECT s FROM StateNm s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateNm.findByActualSalesVolume", query = "SELECT s FROM StateNm s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateNm.findBySalesVolumeRange", query = "SELECT s FROM StateNm s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateNm.findByPrimarySic", query = "SELECT s FROM StateNm s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateNm.findByPrimarySicDescription", query = "SELECT s FROM StateNm s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateNm.findBySecondarySic1", query = "SELECT s FROM StateNm s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateNm.findBySecondarySicDescription1", query = "SELECT s FROM StateNm s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateNm.findBySecondarySic2", query = "SELECT s FROM StateNm s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateNm.findBySecondarySicDescription2", query = "SELECT s FROM StateNm s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateNm.findByCreditAlphaScore", query = "SELECT s FROM StateNm s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateNm.findByCreditNumericScore", query = "SELECT s FROM StateNm s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateNm.findByHeadquartersbranch", query = "SELECT s FROM StateNm s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateNm.findByOfficeSize", query = "SELECT s FROM StateNm s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateNm.findBySquareFootage", query = "SELECT s FROM StateNm s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateNm.findByFirmindividual", query = "SELECT s FROM StateNm s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateNm.findByPublicprivateFlag", query = "SELECT s FROM StateNm s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateNm.findByPcCode", query = "SELECT s FROM StateNm s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateNm.findByFranchisespecialty1", query = "SELECT s FROM StateNm s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateNm.findByFranchisespecialty2", query = "SELECT s FROM StateNm s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateNm.findByIndustrySpecificCodes", query = "SELECT s FROM StateNm s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateNm.findByAdsizeInYellowPages", query = "SELECT s FROM StateNm s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateNm.findByMetroArea", query = "SELECT s FROM StateNm s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateNm.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateNm s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateNm.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateNm s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateNm.findByRownum", query = "SELECT s FROM StateNm s WHERE s.rownum = :rownum")})
public class StateNm implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateNm)) {
            return false;
        }
        StateNm other = (StateNm) object;
    ...
    public String toString() {
        return "src.entities.StateNm[ rownum=" + rownum + " ]";
    }

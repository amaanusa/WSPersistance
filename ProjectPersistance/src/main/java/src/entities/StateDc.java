...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateDc.findAll", query = "SELECT s FROM StateDc s"),
    @NamedQuery(name = "StateDc.findByCompanyName", query = "SELECT s FROM StateDc s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateDc.findByMailingAddress", query = "SELECT s FROM StateDc s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateDc.findByCity", query = "SELECT s FROM StateDc s WHERE s.city = :city"),
    @NamedQuery(name = "StateDc.findByState", query = "SELECT s FROM StateDc s WHERE s.state = :state"),
    @NamedQuery(name = "StateDc.findByZipCode", query = "SELECT s FROM StateDc s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateDc.findByMailingCarrierRoute", query = "SELECT s FROM StateDc s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateDc.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateDc s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateDc.findByStreetAddressCity", query = "SELECT s FROM StateDc s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateDc.findByStreetAddress", query = "SELECT s FROM StateDc s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateDc.findByStreetAddressZip", query = "SELECT s FROM StateDc s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateDc.findByStreetAddressZip4", query = "SELECT s FROM StateDc s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateDc.findByCounty", query = "SELECT s FROM StateDc s WHERE s.county = :county"),
    @NamedQuery(name = "StateDc.findByPhoneNumber", query = "SELECT s FROM StateDc s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateDc.findByFaxNumber", query = "SELECT s FROM StateDc s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateDc.findByWebAddress", query = "SELECT s FROM StateDc s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateDc.findByLastName", query = "SELECT s FROM StateDc s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateDc.findByFirstName", query = "SELECT s FROM StateDc s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateDc.findByContactTitle", query = "SELECT s FROM StateDc s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateDc.findByContactGender", query = "SELECT s FROM StateDc s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateDc.findByActualEmployeeSize", query = "SELECT s FROM StateDc s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateDc.findByEmployeeSizeRange", query = "SELECT s FROM StateDc s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateDc.findByActualSalesVolume", query = "SELECT s FROM StateDc s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateDc.findBySalesVolumeRange", query = "SELECT s FROM StateDc s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateDc.findByPrimarySic", query = "SELECT s FROM StateDc s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateDc.findByPrimarySicDescription", query = "SELECT s FROM StateDc s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateDc.findBySecondarySic1", query = "SELECT s FROM StateDc s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateDc.findBySecondarySicDescription1", query = "SELECT s FROM StateDc s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateDc.findBySecondarySic2", query = "SELECT s FROM StateDc s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateDc.findBySecondarySicDescription2", query = "SELECT s FROM StateDc s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateDc.findByCreditAlphaScore", query = "SELECT s FROM StateDc s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateDc.findByCreditNumericScore", query = "SELECT s FROM StateDc s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateDc.findByHeadquartersbranch", query = "SELECT s FROM StateDc s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateDc.findByOfficeSize", query = "SELECT s FROM StateDc s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateDc.findBySquareFootage", query = "SELECT s FROM StateDc s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateDc.findByFirmindividual", query = "SELECT s FROM StateDc s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateDc.findByPublicprivateFlag", query = "SELECT s FROM StateDc s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateDc.findByPcCode", query = "SELECT s FROM StateDc s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateDc.findByFranchisespecialty1", query = "SELECT s FROM StateDc s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateDc.findByFranchisespecialty2", query = "SELECT s FROM StateDc s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateDc.findByIndustrySpecificCodes", query = "SELECT s FROM StateDc s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateDc.findByAdsizeInYellowPages", query = "SELECT s FROM StateDc s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateDc.findByMetroArea", query = "SELECT s FROM StateDc s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateDc.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateDc s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateDc.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateDc s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateDc.findByRownum", query = "SELECT s FROM StateDc s WHERE s.rownum = :rownum")})
public class StateDc implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateDc)) {
            return false;
        }
        StateDc other = (StateDc) object;
    ...
    public String toString() {
        return "src.entities.StateDc[ rownum=" + rownum + " ]";
    }

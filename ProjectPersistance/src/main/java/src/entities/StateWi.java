...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateWi.findAll", query = "SELECT s FROM StateWi s"),
    @NamedQuery(name = "StateWi.findByCompanyName", query = "SELECT s FROM StateWi s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateWi.findByMailingAddress", query = "SELECT s FROM StateWi s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateWi.findByCity", query = "SELECT s FROM StateWi s WHERE s.city = :city"),
    @NamedQuery(name = "StateWi.findByState", query = "SELECT s FROM StateWi s WHERE s.state = :state"),
    @NamedQuery(name = "StateWi.findByZipCode", query = "SELECT s FROM StateWi s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateWi.findByMailingCarrierRoute", query = "SELECT s FROM StateWi s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateWi.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateWi s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateWi.findByStreetAddress", query = "SELECT s FROM StateWi s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateWi.findByStreetAddressCity", query = "SELECT s FROM StateWi s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateWi.findByStreetAddressState", query = "SELECT s FROM StateWi s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateWi.findByStreetAddressZip", query = "SELECT s FROM StateWi s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateWi.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateWi s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateWi.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateWi s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateWi.findByCounty", query = "SELECT s FROM StateWi s WHERE s.county = :county"),
    @NamedQuery(name = "StateWi.findByPhoneNumber", query = "SELECT s FROM StateWi s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateWi.findByFaxNumber", query = "SELECT s FROM StateWi s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateWi.findByWebAddress", query = "SELECT s FROM StateWi s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateWi.findByLastName", query = "SELECT s FROM StateWi s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateWi.findByFirstName", query = "SELECT s FROM StateWi s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateWi.findByContactTitle", query = "SELECT s FROM StateWi s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateWi.findByContactGender", query = "SELECT s FROM StateWi s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateWi.findByActualEmployeeSize", query = "SELECT s FROM StateWi s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateWi.findByEmployeeSizeRange", query = "SELECT s FROM StateWi s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateWi.findByActualSalesVolume", query = "SELECT s FROM StateWi s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateWi.findBySalesVolumeRange", query = "SELECT s FROM StateWi s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateWi.findByPrimarySic", query = "SELECT s FROM StateWi s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateWi.findByPrimarySicDescription", query = "SELECT s FROM StateWi s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateWi.findBySecondarySic1", query = "SELECT s FROM StateWi s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateWi.findBySecondarySicDescription1", query = "SELECT s FROM StateWi s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateWi.findBySecondarySic2", query = "SELECT s FROM StateWi s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateWi.findBySecondarySicDescription2", query = "SELECT s FROM StateWi s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateWi.findByCreditAlphaScore", query = "SELECT s FROM StateWi s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateWi.findByCreditNumericScore", query = "SELECT s FROM StateWi s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateWi.findByHeadquartersbranch", query = "SELECT s FROM StateWi s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateWi.findByOfficeSize", query = "SELECT s FROM StateWi s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateWi.findBySquareFootage", query = "SELECT s FROM StateWi s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateWi.findByFirmindividual", query = "SELECT s FROM StateWi s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateWi.findByPublicprivateFlag", query = "SELECT s FROM StateWi s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateWi.findByPcCode", query = "SELECT s FROM StateWi s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateWi.findByFranchisespecialty1", query = "SELECT s FROM StateWi s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateWi.findByFranchisespecialty2", query = "SELECT s FROM StateWi s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateWi.findByIndustrySpecificCodes", query = "SELECT s FROM StateWi s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateWi.findByAdsizeInYellowPages", query = "SELECT s FROM StateWi s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateWi.findByMetroArea", query = "SELECT s FROM StateWi s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateWi.findByRownum", query = "SELECT s FROM StateWi s WHERE s.rownum = :rownum")})
public class StateWi implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateWi)) {
            return false;
        }
        StateWi other = (StateWi) object;
    ...
    public String toString() {
        return "src.entities.StateWi[ rownum=" + rownum + " ]";
    }

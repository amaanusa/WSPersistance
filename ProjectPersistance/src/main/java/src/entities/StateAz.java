...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateAz.findAll", query = "SELECT s FROM StateAz s"),
    @NamedQuery(name = "StateAz.findByCompanyName", query = "SELECT s FROM StateAz s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateAz.findByMailingAddress", query = "SELECT s FROM StateAz s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateAz.findByCity", query = "SELECT s FROM StateAz s WHERE s.city = :city"),
    @NamedQuery(name = "StateAz.findByState", query = "SELECT s FROM StateAz s WHERE s.state = :state"),
    @NamedQuery(name = "StateAz.findByZipCode", query = "SELECT s FROM StateAz s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateAz.findByMailingCarrierRoute", query = "SELECT s FROM StateAz s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateAz.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateAz s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateAz.findByStreetAddressCity", query = "SELECT s FROM StateAz s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateAz.findByStreetAddress", query = "SELECT s FROM StateAz s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateAz.findByStreetAddressZip", query = "SELECT s FROM StateAz s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateAz.findByStreetAddressZip4", query = "SELECT s FROM StateAz s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateAz.findByCounty", query = "SELECT s FROM StateAz s WHERE s.county = :county"),
    @NamedQuery(name = "StateAz.findByPhoneNumber", query = "SELECT s FROM StateAz s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateAz.findByFaxNumber", query = "SELECT s FROM StateAz s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateAz.findByWebAddress", query = "SELECT s FROM StateAz s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateAz.findByLastName", query = "SELECT s FROM StateAz s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateAz.findByFirstName", query = "SELECT s FROM StateAz s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateAz.findByContactTitle", query = "SELECT s FROM StateAz s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateAz.findByContactGender", query = "SELECT s FROM StateAz s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateAz.findByActualEmployeeSize", query = "SELECT s FROM StateAz s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateAz.findByEmployeeSizeRange", query = "SELECT s FROM StateAz s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateAz.findByActualSalesVolume", query = "SELECT s FROM StateAz s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateAz.findBySalesVolumeRange", query = "SELECT s FROM StateAz s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateAz.findByPrimarySic", query = "SELECT s FROM StateAz s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateAz.findByPrimarySicDescription", query = "SELECT s FROM StateAz s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateAz.findBySecondarySic1", query = "SELECT s FROM StateAz s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateAz.findBySecondarySicDescription1", query = "SELECT s FROM StateAz s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateAz.findBySecondarySic2", query = "SELECT s FROM StateAz s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateAz.findBySecondarySicDescription2", query = "SELECT s FROM StateAz s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateAz.findByCreditAlphaScore", query = "SELECT s FROM StateAz s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateAz.findByCreditNumericScore", query = "SELECT s FROM StateAz s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateAz.findByHeadquartersbranch", query = "SELECT s FROM StateAz s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateAz.findByOfficeSize", query = "SELECT s FROM StateAz s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateAz.findBySquareFootage", query = "SELECT s FROM StateAz s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateAz.findByFirmindividual", query = "SELECT s FROM StateAz s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateAz.findByPublicprivateFlag", query = "SELECT s FROM StateAz s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateAz.findByPcCode", query = "SELECT s FROM StateAz s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateAz.findByFranchisespecialty1", query = "SELECT s FROM StateAz s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateAz.findByFranchisespecialty2", query = "SELECT s FROM StateAz s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateAz.findByIndustrySpecificCodes", query = "SELECT s FROM StateAz s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateAz.findByAdsizeInYellowPages", query = "SELECT s FROM StateAz s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateAz.findByMetroArea", query = "SELECT s FROM StateAz s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateAz.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateAz s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateAz.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateAz s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateAz.findByRownum", query = "SELECT s FROM StateAz s WHERE s.rownum = :rownum")})
public class StateAz implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateAz)) {
            return false;
        }
        StateAz other = (StateAz) object;
    ...
    public String toString() {
        return "src.entities.StateAz[ rownum=" + rownum + " ]";
    }

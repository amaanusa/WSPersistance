...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateSd.findAll", query = "SELECT s FROM StateSd s"),
    @NamedQuery(name = "StateSd.findByCompanyName", query = "SELECT s FROM StateSd s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateSd.findByMailingAddress", query = "SELECT s FROM StateSd s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateSd.findByCity", query = "SELECT s FROM StateSd s WHERE s.city = :city"),
    @NamedQuery(name = "StateSd.findByState", query = "SELECT s FROM StateSd s WHERE s.state = :state"),
    @NamedQuery(name = "StateSd.findByZipCode", query = "SELECT s FROM StateSd s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateSd.findByMailingCarrierRoute", query = "SELECT s FROM StateSd s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateSd.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateSd s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateSd.findByStreetAddressCity", query = "SELECT s FROM StateSd s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateSd.findByStreetAddress", query = "SELECT s FROM StateSd s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateSd.findByStreetAddressZip", query = "SELECT s FROM StateSd s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateSd.findByStreetAddressZip4", query = "SELECT s FROM StateSd s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateSd.findByCounty", query = "SELECT s FROM StateSd s WHERE s.county = :county"),
    @NamedQuery(name = "StateSd.findByPhoneNumber", query = "SELECT s FROM StateSd s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateSd.findByFaxNumber", query = "SELECT s FROM StateSd s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateSd.findByWebAddress", query = "SELECT s FROM StateSd s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateSd.findByLastName", query = "SELECT s FROM StateSd s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateSd.findByFirstName", query = "SELECT s FROM StateSd s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateSd.findByContactTitle", query = "SELECT s FROM StateSd s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateSd.findByContactGender", query = "SELECT s FROM StateSd s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateSd.findByActualEmployeeSize", query = "SELECT s FROM StateSd s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateSd.findByEmployeeSizeRange", query = "SELECT s FROM StateSd s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateSd.findByActualSalesVolume", query = "SELECT s FROM StateSd s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateSd.findBySalesVolumeRange", query = "SELECT s FROM StateSd s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateSd.findByPrimarySic", query = "SELECT s FROM StateSd s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateSd.findByPrimarySicDescription", query = "SELECT s FROM StateSd s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateSd.findBySecondarySic1", query = "SELECT s FROM StateSd s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateSd.findBySecondarySicDescription1", query = "SELECT s FROM StateSd s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateSd.findBySecondarySic2", query = "SELECT s FROM StateSd s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateSd.findBySecondarySicDescription2", query = "SELECT s FROM StateSd s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateSd.findByCreditAlphaScore", query = "SELECT s FROM StateSd s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateSd.findByCreditNumericScore", query = "SELECT s FROM StateSd s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateSd.findByHeadquartersbranch", query = "SELECT s FROM StateSd s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateSd.findByOfficeSize", query = "SELECT s FROM StateSd s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateSd.findBySquareFootage", query = "SELECT s FROM StateSd s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateSd.findByFirmindividual", query = "SELECT s FROM StateSd s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateSd.findByPublicprivateFlag", query = "SELECT s FROM StateSd s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateSd.findByPcCode", query = "SELECT s FROM StateSd s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateSd.findByFranchisespecialty1", query = "SELECT s FROM StateSd s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateSd.findByFranchisespecialty2", query = "SELECT s FROM StateSd s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateSd.findByIndustrySpecificCodes", query = "SELECT s FROM StateSd s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateSd.findByAdsizeInYellowPages", query = "SELECT s FROM StateSd s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateSd.findByMetroArea", query = "SELECT s FROM StateSd s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateSd.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateSd s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateSd.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateSd s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateSd.findByRownum", query = "SELECT s FROM StateSd s WHERE s.rownum = :rownum")})
public class StateSd implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateSd)) {
            return false;
        }
        StateSd other = (StateSd) object;
    ...
    public String toString() {
        return "src.entities.StateSd[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateWv.findAll", query = "SELECT s FROM StateWv s"),
    @NamedQuery(name = "StateWv.findByCompanyName", query = "SELECT s FROM StateWv s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateWv.findByMailingAddress", query = "SELECT s FROM StateWv s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateWv.findByCity", query = "SELECT s FROM StateWv s WHERE s.city = :city"),
    @NamedQuery(name = "StateWv.findByState", query = "SELECT s FROM StateWv s WHERE s.state = :state"),
    @NamedQuery(name = "StateWv.findByZipCode", query = "SELECT s FROM StateWv s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateWv.findByMailingCarrierRoute", query = "SELECT s FROM StateWv s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateWv.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateWv s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateWv.findByStreetAddress", query = "SELECT s FROM StateWv s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateWv.findByStreetAddressCity", query = "SELECT s FROM StateWv s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateWv.findByStreetAddressState", query = "SELECT s FROM StateWv s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateWv.findByStreetAddressZip", query = "SELECT s FROM StateWv s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateWv.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateWv s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateWv.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateWv s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateWv.findByCounty", query = "SELECT s FROM StateWv s WHERE s.county = :county"),
    @NamedQuery(name = "StateWv.findByPhoneNumber", query = "SELECT s FROM StateWv s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateWv.findByFaxNumber", query = "SELECT s FROM StateWv s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateWv.findByWebAddress", query = "SELECT s FROM StateWv s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateWv.findByLastName", query = "SELECT s FROM StateWv s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateWv.findByFirstName", query = "SELECT s FROM StateWv s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateWv.findByContactTitle", query = "SELECT s FROM StateWv s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateWv.findByContactGender", query = "SELECT s FROM StateWv s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateWv.findByActualEmployeeSize", query = "SELECT s FROM StateWv s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateWv.findByEmployeeSizeRange", query = "SELECT s FROM StateWv s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateWv.findByActualSalesVolume", query = "SELECT s FROM StateWv s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateWv.findBySalesVolumeRange", query = "SELECT s FROM StateWv s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateWv.findByPrimarySic", query = "SELECT s FROM StateWv s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateWv.findByPrimarySicDescription", query = "SELECT s FROM StateWv s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateWv.findBySecondarySic1", query = "SELECT s FROM StateWv s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateWv.findBySecondarySicDescription1", query = "SELECT s FROM StateWv s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateWv.findBySecondarySic2", query = "SELECT s FROM StateWv s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateWv.findBySecondarySicDescription2", query = "SELECT s FROM StateWv s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateWv.findByCreditAlphaScore", query = "SELECT s FROM StateWv s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateWv.findByCreditNumericScore", query = "SELECT s FROM StateWv s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateWv.findByHeadquartersbranch", query = "SELECT s FROM StateWv s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateWv.findByOfficeSize", query = "SELECT s FROM StateWv s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateWv.findBySquareFootage", query = "SELECT s FROM StateWv s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateWv.findByFirmindividual", query = "SELECT s FROM StateWv s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateWv.findByPublicprivateFlag", query = "SELECT s FROM StateWv s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateWv.findByPcCode", query = "SELECT s FROM StateWv s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateWv.findByFranchisespecialty1", query = "SELECT s FROM StateWv s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateWv.findByFranchisespecialty2", query = "SELECT s FROM StateWv s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateWv.findByIndustrySpecificCodes", query = "SELECT s FROM StateWv s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateWv.findByAdsizeInYellowPages", query = "SELECT s FROM StateWv s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateWv.findByMetroArea", query = "SELECT s FROM StateWv s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateWv.findByRownum", query = "SELECT s FROM StateWv s WHERE s.rownum = :rownum")})
public class StateWv implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateWv)) {
            return false;
        }
        StateWv other = (StateWv) object;
    ...
    public String toString() {
        return "src.entities.StateWv[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateHi.findAll", query = "SELECT s FROM StateHi s"),
    @NamedQuery(name = "StateHi.findByCompanyName", query = "SELECT s FROM StateHi s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateHi.findByMailingAddress", query = "SELECT s FROM StateHi s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateHi.findByCity", query = "SELECT s FROM StateHi s WHERE s.city = :city"),
    @NamedQuery(name = "StateHi.findByState", query = "SELECT s FROM StateHi s WHERE s.state = :state"),
    @NamedQuery(name = "StateHi.findByZipCode", query = "SELECT s FROM StateHi s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateHi.findByMailingCarrierRoute", query = "SELECT s FROM StateHi s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateHi.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateHi s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateHi.findByStreetAddress", query = "SELECT s FROM StateHi s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateHi.findByStreetAddressCity", query = "SELECT s FROM StateHi s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateHi.findByStreetAddressState", query = "SELECT s FROM StateHi s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateHi.findByStreetAddressZip", query = "SELECT s FROM StateHi s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateHi.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateHi s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateHi.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateHi s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateHi.findByCounty", query = "SELECT s FROM StateHi s WHERE s.county = :county"),
    @NamedQuery(name = "StateHi.findByPhoneNumber", query = "SELECT s FROM StateHi s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateHi.findByFaxNumber", query = "SELECT s FROM StateHi s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateHi.findByWebAddress", query = "SELECT s FROM StateHi s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateHi.findByLastName", query = "SELECT s FROM StateHi s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateHi.findByFirstName", query = "SELECT s FROM StateHi s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateHi.findByContactTitle", query = "SELECT s FROM StateHi s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateHi.findByContactGender", query = "SELECT s FROM StateHi s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateHi.findByActualEmployeeSize", query = "SELECT s FROM StateHi s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateHi.findByEmployeeSizeRange", query = "SELECT s FROM StateHi s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateHi.findByActualSalesVolume", query = "SELECT s FROM StateHi s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateHi.findBySalesVolumeRange", query = "SELECT s FROM StateHi s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateHi.findByPrimarySic", query = "SELECT s FROM StateHi s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateHi.findByPrimarySicDescription", query = "SELECT s FROM StateHi s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateHi.findBySecondarySic1", query = "SELECT s FROM StateHi s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateHi.findBySecondarySicDescription1", query = "SELECT s FROM StateHi s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateHi.findBySecondarySic2", query = "SELECT s FROM StateHi s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateHi.findBySecondarySicDescription2", query = "SELECT s FROM StateHi s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateHi.findByCreditAlphaScore", query = "SELECT s FROM StateHi s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateHi.findByCreditNumericScore", query = "SELECT s FROM StateHi s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateHi.findByHeadquartersbranch", query = "SELECT s FROM StateHi s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateHi.findByOfficeSize", query = "SELECT s FROM StateHi s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateHi.findBySquareFootage", query = "SELECT s FROM StateHi s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateHi.findByFirmindividual", query = "SELECT s FROM StateHi s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateHi.findByPublicprivateFlag", query = "SELECT s FROM StateHi s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateHi.findByPcCode", query = "SELECT s FROM StateHi s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateHi.findByFranchisespecialty1", query = "SELECT s FROM StateHi s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateHi.findByFranchisespecialty2", query = "SELECT s FROM StateHi s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateHi.findByIndustrySpecificCodes", query = "SELECT s FROM StateHi s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateHi.findByAdsizeInYellowPages", query = "SELECT s FROM StateHi s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateHi.findByMetroArea", query = "SELECT s FROM StateHi s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateHi.findByRownum", query = "SELECT s FROM StateHi s WHERE s.rownum = :rownum")})
public class StateHi implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateHi)) {
            return false;
        }
        StateHi other = (StateHi) object;
    ...
    public String toString() {
        return "src.entities.StateHi[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateVt.findAll", query = "SELECT s FROM StateVt s"),
    @NamedQuery(name = "StateVt.findByCompanyName", query = "SELECT s FROM StateVt s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateVt.findByMailingAddress", query = "SELECT s FROM StateVt s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateVt.findByCity", query = "SELECT s FROM StateVt s WHERE s.city = :city"),
    @NamedQuery(name = "StateVt.findByState", query = "SELECT s FROM StateVt s WHERE s.state = :state"),
    @NamedQuery(name = "StateVt.findByZipCode", query = "SELECT s FROM StateVt s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateVt.findByMailingCarrierRoute", query = "SELECT s FROM StateVt s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateVt.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateVt s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateVt.findByStreetAddress", query = "SELECT s FROM StateVt s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateVt.findByStreetAddressCity", query = "SELECT s FROM StateVt s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateVt.findByStreetAddressState", query = "SELECT s FROM StateVt s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateVt.findByStreetAddressZip", query = "SELECT s FROM StateVt s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateVt.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateVt s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateVt.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateVt s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateVt.findByCounty", query = "SELECT s FROM StateVt s WHERE s.county = :county"),
    @NamedQuery(name = "StateVt.findByPhoneNumber", query = "SELECT s FROM StateVt s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateVt.findByFaxNumber", query = "SELECT s FROM StateVt s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateVt.findByWebAddress", query = "SELECT s FROM StateVt s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateVt.findByLastName", query = "SELECT s FROM StateVt s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateVt.findByFirstName", query = "SELECT s FROM StateVt s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateVt.findByContactTitle", query = "SELECT s FROM StateVt s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateVt.findByContactGender", query = "SELECT s FROM StateVt s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateVt.findByActualEmployeeSize", query = "SELECT s FROM StateVt s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateVt.findByEmployeeSizeRange", query = "SELECT s FROM StateVt s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateVt.findByActualSalesVolume", query = "SELECT s FROM StateVt s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateVt.findBySalesVolumeRange", query = "SELECT s FROM StateVt s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateVt.findByPrimarySic", query = "SELECT s FROM StateVt s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateVt.findByPrimarySicDescription", query = "SELECT s FROM StateVt s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateVt.findBySecondarySic1", query = "SELECT s FROM StateVt s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateVt.findBySecondarySicDescription1", query = "SELECT s FROM StateVt s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateVt.findBySecondarySic2", query = "SELECT s FROM StateVt s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateVt.findBySecondarySicDescription2", query = "SELECT s FROM StateVt s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateVt.findByCreditAlphaScore", query = "SELECT s FROM StateVt s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateVt.findByCreditNumericScore", query = "SELECT s FROM StateVt s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateVt.findByHeadquartersbranch", query = "SELECT s FROM StateVt s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateVt.findByOfficeSize", query = "SELECT s FROM StateVt s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateVt.findBySquareFootage", query = "SELECT s FROM StateVt s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateVt.findByFirmindividual", query = "SELECT s FROM StateVt s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateVt.findByPublicprivateFlag", query = "SELECT s FROM StateVt s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateVt.findByPcCode", query = "SELECT s FROM StateVt s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateVt.findByFranchisespecialty1", query = "SELECT s FROM StateVt s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateVt.findByFranchisespecialty2", query = "SELECT s FROM StateVt s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateVt.findByIndustrySpecificCodes", query = "SELECT s FROM StateVt s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateVt.findByAdsizeInYellowPages", query = "SELECT s FROM StateVt s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateVt.findByMetroArea", query = "SELECT s FROM StateVt s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateVt.findByRownum", query = "SELECT s FROM StateVt s WHERE s.rownum = :rownum")})
public class StateVt implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateVt)) {
            return false;
        }
        StateVt other = (StateVt) object;
    ...
    public String toString() {
        return "src.entities.StateVt[ rownum=" + rownum + " ]";
    }

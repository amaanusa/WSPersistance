...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateSc.findAll", query = "SELECT s FROM StateSc s"),
    @NamedQuery(name = "StateSc.findByCompanyName", query = "SELECT s FROM StateSc s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateSc.findByMailingAddress", query = "SELECT s FROM StateSc s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateSc.findByCity", query = "SELECT s FROM StateSc s WHERE s.city = :city"),
    @NamedQuery(name = "StateSc.findByState", query = "SELECT s FROM StateSc s WHERE s.state = :state"),
    @NamedQuery(name = "StateSc.findByZipCode", query = "SELECT s FROM StateSc s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateSc.findByMailingCarrierRoute", query = "SELECT s FROM StateSc s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateSc.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateSc s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateSc.findByStreetAddressCity", query = "SELECT s FROM StateSc s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateSc.findByStreetAddress", query = "SELECT s FROM StateSc s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateSc.findByStreetAddressZip", query = "SELECT s FROM StateSc s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateSc.findByStreetAddressZip4", query = "SELECT s FROM StateSc s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateSc.findByCounty", query = "SELECT s FROM StateSc s WHERE s.county = :county"),
    @NamedQuery(name = "StateSc.findByPhoneNumber", query = "SELECT s FROM StateSc s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateSc.findByFaxNumber", query = "SELECT s FROM StateSc s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateSc.findByWebAddress", query = "SELECT s FROM StateSc s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateSc.findByLastName", query = "SELECT s FROM StateSc s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateSc.findByFirstName", query = "SELECT s FROM StateSc s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateSc.findByContactTitle", query = "SELECT s FROM StateSc s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateSc.findByContactGender", query = "SELECT s FROM StateSc s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateSc.findByActualEmployeeSize", query = "SELECT s FROM StateSc s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateSc.findByEmployeeSizeRange", query = "SELECT s FROM StateSc s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateSc.findByActualSalesVolume", query = "SELECT s FROM StateSc s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateSc.findBySalesVolumeRange", query = "SELECT s FROM StateSc s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateSc.findByPrimarySic", query = "SELECT s FROM StateSc s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateSc.findByPrimarySicDescription", query = "SELECT s FROM StateSc s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateSc.findBySecondarySic1", query = "SELECT s FROM StateSc s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateSc.findBySecondarySicDescription1", query = "SELECT s FROM StateSc s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateSc.findBySecondarySic2", query = "SELECT s FROM StateSc s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateSc.findBySecondarySicDescription2", query = "SELECT s FROM StateSc s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateSc.findByCreditAlphaScore", query = "SELECT s FROM StateSc s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateSc.findByCreditNumericScore", query = "SELECT s FROM StateSc s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateSc.findByHeadquartersbranch", query = "SELECT s FROM StateSc s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateSc.findByOfficeSize", query = "SELECT s FROM StateSc s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateSc.findBySquareFootage", query = "SELECT s FROM StateSc s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateSc.findByFirmindividual", query = "SELECT s FROM StateSc s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateSc.findByPublicprivateFlag", query = "SELECT s FROM StateSc s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateSc.findByPcCode", query = "SELECT s FROM StateSc s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateSc.findByFranchisespecialty1", query = "SELECT s FROM StateSc s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateSc.findByFranchisespecialty2", query = "SELECT s FROM StateSc s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateSc.findByIndustrySpecificCodes", query = "SELECT s FROM StateSc s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateSc.findByAdsizeInYellowPages", query = "SELECT s FROM StateSc s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateSc.findByMetroArea", query = "SELECT s FROM StateSc s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateSc.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateSc s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateSc.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateSc s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateSc.findByRownum", query = "SELECT s FROM StateSc s WHERE s.rownum = :rownum")})
public class StateSc implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateSc)) {
            return false;
        }
        StateSc other = (StateSc) object;
    ...
    public String toString() {
        return "src.entities.StateSc[ rownum=" + rownum + " ]";
    }

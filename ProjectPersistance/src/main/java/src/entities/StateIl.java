...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateIl.findAll", query = "SELECT s FROM StateIl s"),
    @NamedQuery(name = "StateIl.findByCompanyName", query = "SELECT s FROM StateIl s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateIl.findByMailingAddress", query = "SELECT s FROM StateIl s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateIl.findByCity", query = "SELECT s FROM StateIl s WHERE s.city = :city"),
    @NamedQuery(name = "StateIl.findByState", query = "SELECT s FROM StateIl s WHERE s.state = :state"),
    @NamedQuery(name = "StateIl.findByZipCode", query = "SELECT s FROM StateIl s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateIl.findByMailingCarrierRoute", query = "SELECT s FROM StateIl s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateIl.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateIl s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateIl.findByStreetAddress", query = "SELECT s FROM StateIl s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateIl.findByStreetAddressCity", query = "SELECT s FROM StateIl s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateIl.findByStreetAddressState", query = "SELECT s FROM StateIl s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateIl.findByStreetAddressZip", query = "SELECT s FROM StateIl s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateIl.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateIl s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateIl.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateIl s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateIl.findByCounty", query = "SELECT s FROM StateIl s WHERE s.county = :county"),
    @NamedQuery(name = "StateIl.findByPhoneNumber", query = "SELECT s FROM StateIl s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateIl.findByFaxNumber", query = "SELECT s FROM StateIl s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateIl.findByWebAddress", query = "SELECT s FROM StateIl s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateIl.findByLastName", query = "SELECT s FROM StateIl s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateIl.findByFirstName", query = "SELECT s FROM StateIl s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateIl.findByContactTitle", query = "SELECT s FROM StateIl s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateIl.findByContactGender", query = "SELECT s FROM StateIl s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateIl.findByActualEmployeeSize", query = "SELECT s FROM StateIl s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateIl.findByEmployeeSizeRange", query = "SELECT s FROM StateIl s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateIl.findByActualSalesVolume", query = "SELECT s FROM StateIl s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateIl.findBySalesVolumeRange", query = "SELECT s FROM StateIl s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateIl.findByPrimarySic", query = "SELECT s FROM StateIl s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateIl.findByPrimarySicDescription", query = "SELECT s FROM StateIl s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateIl.findBySecondarySic1", query = "SELECT s FROM StateIl s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateIl.findBySecondarySicDescription1", query = "SELECT s FROM StateIl s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateIl.findBySecondarySic2", query = "SELECT s FROM StateIl s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateIl.findBySecondarySicDescription2", query = "SELECT s FROM StateIl s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateIl.findByCreditAlphaScore", query = "SELECT s FROM StateIl s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateIl.findByCreditNumericScore", query = "SELECT s FROM StateIl s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateIl.findByHeadquartersbranch", query = "SELECT s FROM StateIl s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateIl.findByYear1stAppeared", query = "SELECT s FROM StateIl s WHERE s.year1stAppeared = :year1stAppeared"),
    @NamedQuery(name = "StateIl.findByOfficeSize", query = "SELECT s FROM StateIl s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateIl.findBySquareFootage", query = "SELECT s FROM StateIl s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateIl.findByFirmindividual", query = "SELECT s FROM StateIl s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateIl.findByPublicprivateFlag", query = "SELECT s FROM StateIl s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateIl.findByPcCode", query = "SELECT s FROM StateIl s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateIl.findByFranchisespecialty1", query = "SELECT s FROM StateIl s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateIl.findByFranchisespecialty2", query = "SELECT s FROM StateIl s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateIl.findByIndustrySpecificCodes", query = "SELECT s FROM StateIl s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateIl.findByAdsizeInYellowPages", query = "SELECT s FROM StateIl s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateIl.findByMetroArea", query = "SELECT s FROM StateIl s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateIl.findByRownum", query = "SELECT s FROM StateIl s WHERE s.rownum = :rownum")})
public class StateIl implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateIl)) {
            return false;
        }
        StateIl other = (StateIl) object;
    ...
    public String toString() {
        return "src.entities.StateIl[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateWy.findAll", query = "SELECT s FROM StateWy s"),
    @NamedQuery(name = "StateWy.findByCompanyName", query = "SELECT s FROM StateWy s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateWy.findByMailingAddress", query = "SELECT s FROM StateWy s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateWy.findByCity", query = "SELECT s FROM StateWy s WHERE s.city = :city"),
    @NamedQuery(name = "StateWy.findByState", query = "SELECT s FROM StateWy s WHERE s.state = :state"),
    @NamedQuery(name = "StateWy.findByZipCode", query = "SELECT s FROM StateWy s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateWy.findByMailingCarrierRoute", query = "SELECT s FROM StateWy s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateWy.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateWy s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateWy.findByStreetAddress", query = "SELECT s FROM StateWy s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateWy.findByStreetAddressCity", query = "SELECT s FROM StateWy s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateWy.findByStreetAddressState", query = "SELECT s FROM StateWy s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateWy.findByStreetAddressZip", query = "SELECT s FROM StateWy s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateWy.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateWy s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateWy.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateWy s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateWy.findByCounty", query = "SELECT s FROM StateWy s WHERE s.county = :county"),
    @NamedQuery(name = "StateWy.findByPhoneNumber", query = "SELECT s FROM StateWy s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateWy.findByFaxNumber", query = "SELECT s FROM StateWy s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateWy.findByWebAddress", query = "SELECT s FROM StateWy s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateWy.findByLastName", query = "SELECT s FROM StateWy s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateWy.findByFirstName", query = "SELECT s FROM StateWy s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateWy.findByContactTitle", query = "SELECT s FROM StateWy s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateWy.findByContactGender", query = "SELECT s FROM StateWy s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateWy.findByActualEmployeeSize", query = "SELECT s FROM StateWy s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateWy.findByEmployeeSizeRange", query = "SELECT s FROM StateWy s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateWy.findByActualSalesVolume", query = "SELECT s FROM StateWy s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateWy.findBySalesVolumeRange", query = "SELECT s FROM StateWy s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateWy.findByPrimarySic", query = "SELECT s FROM StateWy s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateWy.findByPrimarySicDescription", query = "SELECT s FROM StateWy s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateWy.findBySecondarySic1", query = "SELECT s FROM StateWy s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateWy.findBySecondarySicDescription1", query = "SELECT s FROM StateWy s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateWy.findBySecondarySic2", query = "SELECT s FROM StateWy s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateWy.findBySecondarySicDescription2", query = "SELECT s FROM StateWy s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateWy.findByCreditAlphaScore", query = "SELECT s FROM StateWy s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateWy.findByCreditNumericScore", query = "SELECT s FROM StateWy s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateWy.findByHeadquartersbranch", query = "SELECT s FROM StateWy s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateWy.findByOfficeSize", query = "SELECT s FROM StateWy s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateWy.findBySquareFootage", query = "SELECT s FROM StateWy s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateWy.findByFirmindividual", query = "SELECT s FROM StateWy s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateWy.findByPublicprivateFlag", query = "SELECT s FROM StateWy s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateWy.findByPcCode", query = "SELECT s FROM StateWy s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateWy.findByFranchisespecialty1", query = "SELECT s FROM StateWy s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateWy.findByFranchisespecialty2", query = "SELECT s FROM StateWy s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateWy.findByIndustrySpecificCodes", query = "SELECT s FROM StateWy s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateWy.findByAdsizeInYellowPages", query = "SELECT s FROM StateWy s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateWy.findByMetroArea", query = "SELECT s FROM StateWy s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateWy.findByRownum", query = "SELECT s FROM StateWy s WHERE s.rownum = :rownum")})
public class StateWy implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateWy)) {
            return false;
        }
        StateWy other = (StateWy) object;
    ...
    public String toString() {
        return "src.entities.StateWy[ rownum=" + rownum + " ]";
    }

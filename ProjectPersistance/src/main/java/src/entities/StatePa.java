...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StatePa.findAll", query = "SELECT s FROM StatePa s"),
    @NamedQuery(name = "StatePa.findByCompanyName", query = "SELECT s FROM StatePa s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StatePa.findByMailingAddress", query = "SELECT s FROM StatePa s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StatePa.findByCity", query = "SELECT s FROM StatePa s WHERE s.city = :city"),
    @NamedQuery(name = "StatePa.findByState", query = "SELECT s FROM StatePa s WHERE s.state = :state"),
    @NamedQuery(name = "StatePa.findByZipCode", query = "SELECT s FROM StatePa s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StatePa.findByMailingCarrierRoute", query = "SELECT s FROM StatePa s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StatePa.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StatePa s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StatePa.findByStreetAddress", query = "SELECT s FROM StatePa s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StatePa.findByStreetAddressCity", query = "SELECT s FROM StatePa s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StatePa.findByStreetAddressState", query = "SELECT s FROM StatePa s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StatePa.findByStreetAddressZip", query = "SELECT s FROM StatePa s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StatePa.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StatePa s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StatePa.findByStreetAddressCarrierRoute", query = "SELECT s FROM StatePa s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StatePa.findByCounty", query = "SELECT s FROM StatePa s WHERE s.county = :county"),
    @NamedQuery(name = "StatePa.findByPhoneNumber", query = "SELECT s FROM StatePa s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StatePa.findByFaxNumber", query = "SELECT s FROM StatePa s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StatePa.findByWebAddress", query = "SELECT s FROM StatePa s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StatePa.findByLastName", query = "SELECT s FROM StatePa s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StatePa.findByFirstName", query = "SELECT s FROM StatePa s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StatePa.findByContactTitle", query = "SELECT s FROM StatePa s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StatePa.findByContactGender", query = "SELECT s FROM StatePa s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StatePa.findByActualEmployeeSize", query = "SELECT s FROM StatePa s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StatePa.findByEmployeeSizeRange", query = "SELECT s FROM StatePa s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StatePa.findByActualSalesVolume", query = "SELECT s FROM StatePa s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StatePa.findBySalesVolumeRange", query = "SELECT s FROM StatePa s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StatePa.findByPrimarySic", query = "SELECT s FROM StatePa s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StatePa.findByPrimarySicDescription", query = "SELECT s FROM StatePa s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StatePa.findBySecondarySic1", query = "SELECT s FROM StatePa s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StatePa.findBySecondarySicDescription1", query = "SELECT s FROM StatePa s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StatePa.findBySecondarySic2", query = "SELECT s FROM StatePa s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StatePa.findBySecondarySicDescription2", query = "SELECT s FROM StatePa s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StatePa.findByCreditAlphaScore", query = "SELECT s FROM StatePa s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StatePa.findByCreditNumericScore", query = "SELECT s FROM StatePa s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StatePa.findByHeadquartersbranch", query = "SELECT s FROM StatePa s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StatePa.findByOfficeSize", query = "SELECT s FROM StatePa s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StatePa.findBySquareFootage", query = "SELECT s FROM StatePa s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StatePa.findByFirmindividual", query = "SELECT s FROM StatePa s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StatePa.findByPublicprivateFlag", query = "SELECT s FROM StatePa s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StatePa.findByPcCode", query = "SELECT s FROM StatePa s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StatePa.findByFranchisespecialty1", query = "SELECT s FROM StatePa s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StatePa.findByFranchisespecialty2", query = "SELECT s FROM StatePa s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StatePa.findByIndustrySpecificCodes", query = "SELECT s FROM StatePa s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StatePa.findByAdsizeInYellowPages", query = "SELECT s FROM StatePa s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StatePa.findByMetroArea", query = "SELECT s FROM StatePa s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StatePa.findByRownum", query = "SELECT s FROM StatePa s WHERE s.rownum = :rownum")})
public class StatePa implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StatePa)) {
            return false;
        }
        StatePa other = (StatePa) object;
    ...
    public String toString() {
        return "src.entities.StatePa[ rownum=" + rownum + " ]";
    }

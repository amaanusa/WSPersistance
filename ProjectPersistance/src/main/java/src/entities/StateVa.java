...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateVa.findAll", query = "SELECT s FROM StateVa s"),
    @NamedQuery(name = "StateVa.findByCompanyName", query = "SELECT s FROM StateVa s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateVa.findByMailingAddress", query = "SELECT s FROM StateVa s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateVa.findByCity", query = "SELECT s FROM StateVa s WHERE s.city = :city"),
    @NamedQuery(name = "StateVa.findByState", query = "SELECT s FROM StateVa s WHERE s.state = :state"),
    @NamedQuery(name = "StateVa.findByZipCode", query = "SELECT s FROM StateVa s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateVa.findByMailingCarrierRoute", query = "SELECT s FROM StateVa s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateVa.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateVa s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateVa.findByStreetAddress", query = "SELECT s FROM StateVa s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateVa.findByStreetAddressCity", query = "SELECT s FROM StateVa s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateVa.findByStreetAddressState", query = "SELECT s FROM StateVa s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateVa.findByStreetAddressZip", query = "SELECT s FROM StateVa s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateVa.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateVa s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateVa.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateVa s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateVa.findByCounty", query = "SELECT s FROM StateVa s WHERE s.county = :county"),
    @NamedQuery(name = "StateVa.findByPhoneNumber", query = "SELECT s FROM StateVa s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateVa.findByFaxNumber", query = "SELECT s FROM StateVa s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateVa.findByWebAddress", query = "SELECT s FROM StateVa s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateVa.findByLastName", query = "SELECT s FROM StateVa s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateVa.findByFirstName", query = "SELECT s FROM StateVa s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateVa.findByContactTitle", query = "SELECT s FROM StateVa s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateVa.findByContactGender", query = "SELECT s FROM StateVa s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateVa.findByActualEmployeeSize", query = "SELECT s FROM StateVa s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateVa.findByEmployeeSizeRange", query = "SELECT s FROM StateVa s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateVa.findByActualSalesVolume", query = "SELECT s FROM StateVa s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateVa.findBySalesVolumeRange", query = "SELECT s FROM StateVa s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateVa.findByPrimarySic", query = "SELECT s FROM StateVa s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateVa.findByPrimarySicDescription", query = "SELECT s FROM StateVa s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateVa.findBySecondarySic1", query = "SELECT s FROM StateVa s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateVa.findBySecondarySicDescription1", query = "SELECT s FROM StateVa s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateVa.findBySecondarySic2", query = "SELECT s FROM StateVa s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateVa.findBySecondarySicDescription2", query = "SELECT s FROM StateVa s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateVa.findByCreditAlphaScore", query = "SELECT s FROM StateVa s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateVa.findByCreditNumericScore", query = "SELECT s FROM StateVa s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateVa.findByHeadquartersbranch", query = "SELECT s FROM StateVa s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateVa.findByOfficeSize", query = "SELECT s FROM StateVa s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateVa.findBySquareFootage", query = "SELECT s FROM StateVa s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateVa.findByFirmindividual", query = "SELECT s FROM StateVa s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateVa.findByPublicprivateFlag", query = "SELECT s FROM StateVa s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateVa.findByPcCode", query = "SELECT s FROM StateVa s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateVa.findByFranchisespecialty1", query = "SELECT s FROM StateVa s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateVa.findByFranchisespecialty2", query = "SELECT s FROM StateVa s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateVa.findByIndustrySpecificCodes", query = "SELECT s FROM StateVa s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateVa.findByAdsizeInYellowPages", query = "SELECT s FROM StateVa s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateVa.findByMetroArea", query = "SELECT s FROM StateVa s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateVa.findByRownum", query = "SELECT s FROM StateVa s WHERE s.rownum = :rownum")})
public class StateVa implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateVa)) {
            return false;
        }
        StateVa other = (StateVa) object;
    ...
    public String toString() {
        return "src.entities.StateVa[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateNy.findAll", query = "SELECT s FROM StateNy s"),
    @NamedQuery(name = "StateNy.findByCompanyName", query = "SELECT s FROM StateNy s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateNy.findByMailingAddress", query = "SELECT s FROM StateNy s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateNy.findByCity", query = "SELECT s FROM StateNy s WHERE s.city = :city"),
    @NamedQuery(name = "StateNy.findByState", query = "SELECT s FROM StateNy s WHERE s.state = :state"),
    @NamedQuery(name = "StateNy.findByZipCode", query = "SELECT s FROM StateNy s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateNy.findByMailingCarrierRoute", query = "SELECT s FROM StateNy s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateNy.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateNy s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateNy.findByStreetAddressCity", query = "SELECT s FROM StateNy s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateNy.findByStreetAddress", query = "SELECT s FROM StateNy s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateNy.findByStreetAddressZip", query = "SELECT s FROM StateNy s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateNy.findByStreetAddressZip4", query = "SELECT s FROM StateNy s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateNy.findByCounty", query = "SELECT s FROM StateNy s WHERE s.county = :county"),
    @NamedQuery(name = "StateNy.findByPhoneNumber", query = "SELECT s FROM StateNy s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateNy.findByFaxNumber", query = "SELECT s FROM StateNy s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateNy.findByWebAddress", query = "SELECT s FROM StateNy s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateNy.findByLastName", query = "SELECT s FROM StateNy s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateNy.findByFirstName", query = "SELECT s FROM StateNy s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateNy.findByContactTitle", query = "SELECT s FROM StateNy s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateNy.findByContactGender", query = "SELECT s FROM StateNy s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateNy.findByActualEmployeeSize", query = "SELECT s FROM StateNy s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateNy.findByEmployeeSizeRange", query = "SELECT s FROM StateNy s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateNy.findByActualSalesVolume", query = "SELECT s FROM StateNy s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateNy.findBySalesVolumeRange", query = "SELECT s FROM StateNy s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateNy.findByPrimarySic", query = "SELECT s FROM StateNy s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateNy.findByPrimarySicDescription", query = "SELECT s FROM StateNy s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateNy.findBySecondarySic1", query = "SELECT s FROM StateNy s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateNy.findBySecondarySicDescription1", query = "SELECT s FROM StateNy s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateNy.findBySecondarySic2", query = "SELECT s FROM StateNy s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateNy.findBySecondarySicDescription2", query = "SELECT s FROM StateNy s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateNy.findByCreditAlphaScore", query = "SELECT s FROM StateNy s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateNy.findByCreditNumericScore", query = "SELECT s FROM StateNy s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateNy.findByHeadquartersbranch", query = "SELECT s FROM StateNy s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateNy.findByOfficeSize", query = "SELECT s FROM StateNy s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateNy.findBySquareFootage", query = "SELECT s FROM StateNy s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateNy.findByFirmindividual", query = "SELECT s FROM StateNy s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateNy.findByPublicprivateFlag", query = "SELECT s FROM StateNy s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateNy.findByPcCode", query = "SELECT s FROM StateNy s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateNy.findByFranchisespecialty1", query = "SELECT s FROM StateNy s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateNy.findByFranchisespecialty2", query = "SELECT s FROM StateNy s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateNy.findByIndustrySpecificCodes", query = "SELECT s FROM StateNy s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateNy.findByAdsizeInYellowPages", query = "SELECT s FROM StateNy s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateNy.findByMetroArea", query = "SELECT s FROM StateNy s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateNy.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateNy s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateNy.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateNy s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateNy.findByRownum", query = "SELECT s FROM StateNy s WHERE s.rownum = :rownum")})
public class StateNy implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateNy)) {
            return false;
        }
        StateNy other = (StateNy) object;
    ...
    public String toString() {
        return "src.entities.StateNy[ rownum=" + rownum + " ]";
    }

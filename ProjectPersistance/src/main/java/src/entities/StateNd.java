...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateNd.findAll", query = "SELECT s FROM StateNd s"),
    @NamedQuery(name = "StateNd.findByCompanyName", query = "SELECT s FROM StateNd s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateNd.findByMailingAddress", query = "SELECT s FROM StateNd s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateNd.findByCity", query = "SELECT s FROM StateNd s WHERE s.city = :city"),
    @NamedQuery(name = "StateNd.findByState", query = "SELECT s FROM StateNd s WHERE s.state = :state"),
    @NamedQuery(name = "StateNd.findByZipCode", query = "SELECT s FROM StateNd s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateNd.findByMailingCarrierRoute", query = "SELECT s FROM StateNd s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateNd.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateNd s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateNd.findByStreetAddressCity", query = "SELECT s FROM StateNd s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateNd.findByStreetAddress", query = "SELECT s FROM StateNd s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateNd.findByStreetAddressZip", query = "SELECT s FROM StateNd s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateNd.findByStreetAddressZip4", query = "SELECT s FROM StateNd s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateNd.findByCounty", query = "SELECT s FROM StateNd s WHERE s.county = :county"),
    @NamedQuery(name = "StateNd.findByPhoneNumber", query = "SELECT s FROM StateNd s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateNd.findByFaxNumber", query = "SELECT s FROM StateNd s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateNd.findByWebAddress", query = "SELECT s FROM StateNd s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateNd.findByLastName", query = "SELECT s FROM StateNd s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateNd.findByFirstName", query = "SELECT s FROM StateNd s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateNd.findByContactTitle", query = "SELECT s FROM StateNd s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateNd.findByContactGender", query = "SELECT s FROM StateNd s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateNd.findByActualEmployeeSize", query = "SELECT s FROM StateNd s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateNd.findByEmployeeSizeRange", query = "SELECT s FROM StateNd s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateNd.findByActualSalesVolume", query = "SELECT s FROM StateNd s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateNd.findBySalesVolumeRange", query = "SELECT s FROM StateNd s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateNd.findByPrimarySic", query = "SELECT s FROM StateNd s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateNd.findByPrimarySicDescription", query = "SELECT s FROM StateNd s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateNd.findBySecondarySic1", query = "SELECT s FROM StateNd s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateNd.findBySecondarySicDescription1", query = "SELECT s FROM StateNd s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateNd.findBySecondarySic2", query = "SELECT s FROM StateNd s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateNd.findBySecondarySicDescription2", query = "SELECT s FROM StateNd s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateNd.findByCreditAlphaScore", query = "SELECT s FROM StateNd s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateNd.findByCreditNumericScore", query = "SELECT s FROM StateNd s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateNd.findByHeadquartersbranch", query = "SELECT s FROM StateNd s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateNd.findByOfficeSize", query = "SELECT s FROM StateNd s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateNd.findBySquareFootage", query = "SELECT s FROM StateNd s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateNd.findByFirmindividual", query = "SELECT s FROM StateNd s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateNd.findByPublicprivateFlag", query = "SELECT s FROM StateNd s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateNd.findByPcCode", query = "SELECT s FROM StateNd s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateNd.findByFranchisespecialty1", query = "SELECT s FROM StateNd s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateNd.findByFranchisespecialty2", query = "SELECT s FROM StateNd s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateNd.findByIndustrySpecificCodes", query = "SELECT s FROM StateNd s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateNd.findByAdsizeInYellowPages", query = "SELECT s FROM StateNd s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateNd.findByMetroArea", query = "SELECT s FROM StateNd s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateNd.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateNd s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateNd.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateNd s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateNd.findByRownum", query = "SELECT s FROM StateNd s WHERE s.rownum = :rownum")})
public class StateNd implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateNd)) {
            return false;
        }
        StateNd other = (StateNd) object;
    ...
    public String toString() {
        return "src.entities.StateNd[ rownum=" + rownum + " ]";
    }

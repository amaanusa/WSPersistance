...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateMn.findAll", query = "SELECT s FROM StateMn s"),
    @NamedQuery(name = "StateMn.findByCompanyName", query = "SELECT s FROM StateMn s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateMn.findByMailingAddress", query = "SELECT s FROM StateMn s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateMn.findByCity", query = "SELECT s FROM StateMn s WHERE s.city = :city"),
    @NamedQuery(name = "StateMn.findByState", query = "SELECT s FROM StateMn s WHERE s.state = :state"),
    @NamedQuery(name = "StateMn.findByZipCode", query = "SELECT s FROM StateMn s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateMn.findByMailingCarrierRoute", query = "SELECT s FROM StateMn s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateMn.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateMn s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateMn.findByStreetAddress", query = "SELECT s FROM StateMn s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateMn.findByStreetAddressCity", query = "SELECT s FROM StateMn s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateMn.findByStreetAddressState", query = "SELECT s FROM StateMn s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateMn.findByStreetAddressZip", query = "SELECT s FROM StateMn s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateMn.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateMn s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateMn.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateMn s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateMn.findByCounty", query = "SELECT s FROM StateMn s WHERE s.county = :county"),
    @NamedQuery(name = "StateMn.findByPhoneNumber", query = "SELECT s FROM StateMn s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateMn.findByFaxNumber", query = "SELECT s FROM StateMn s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateMn.findByWebAddress", query = "SELECT s FROM StateMn s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateMn.findByLastName", query = "SELECT s FROM StateMn s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateMn.findByFirstName", query = "SELECT s FROM StateMn s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateMn.findByContactTitle", query = "SELECT s FROM StateMn s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateMn.findByContactGender", query = "SELECT s FROM StateMn s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateMn.findByActualEmployeeSize", query = "SELECT s FROM StateMn s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateMn.findByEmployeeSizeRange", query = "SELECT s FROM StateMn s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateMn.findByActualSalesVolume", query = "SELECT s FROM StateMn s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateMn.findBySalesVolumeRange", query = "SELECT s FROM StateMn s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateMn.findByPrimarySic", query = "SELECT s FROM StateMn s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateMn.findByPrimarySicDescription", query = "SELECT s FROM StateMn s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateMn.findBySecondarySic1", query = "SELECT s FROM StateMn s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateMn.findBySecondarySicDescription1", query = "SELECT s FROM StateMn s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateMn.findBySecondarySic2", query = "SELECT s FROM StateMn s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateMn.findBySecondarySicDescription2", query = "SELECT s FROM StateMn s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateMn.findByCreditAlphaScore", query = "SELECT s FROM StateMn s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateMn.findByCreditNumericScore", query = "SELECT s FROM StateMn s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateMn.findByHeadquartersbranch", query = "SELECT s FROM StateMn s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateMn.findByOfficeSize", query = "SELECT s FROM StateMn s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateMn.findBySquareFootage", query = "SELECT s FROM StateMn s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateMn.findByFirmindividual", query = "SELECT s FROM StateMn s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateMn.findByPublicprivateFlag", query = "SELECT s FROM StateMn s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateMn.findByPcCode", query = "SELECT s FROM StateMn s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateMn.findByFranchisespecialty1", query = "SELECT s FROM StateMn s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateMn.findByFranchisespecialty2", query = "SELECT s FROM StateMn s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateMn.findByIndustrySpecificCodes", query = "SELECT s FROM StateMn s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateMn.findByAdsizeInYellowPages", query = "SELECT s FROM StateMn s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateMn.findByMetroArea", query = "SELECT s FROM StateMn s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateMn.findByRownum", query = "SELECT s FROM StateMn s WHERE s.rownum = :rownum")})
public class StateMn implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateMn)) {
            return false;
        }
        StateMn other = (StateMn) object;
    ...
    public String toString() {
        return "src.entities.StateMn[ rownum=" + rownum + " ]";
    }

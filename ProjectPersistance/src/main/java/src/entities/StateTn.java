...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateTn.findAll", query = "SELECT s FROM StateTn s"),
    @NamedQuery(name = "StateTn.findByCompanyName", query = "SELECT s FROM StateTn s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateTn.findByMailingAddress", query = "SELECT s FROM StateTn s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateTn.findByCity", query = "SELECT s FROM StateTn s WHERE s.city = :city"),
    @NamedQuery(name = "StateTn.findByState", query = "SELECT s FROM StateTn s WHERE s.state = :state"),
    @NamedQuery(name = "StateTn.findByZipCode", query = "SELECT s FROM StateTn s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateTn.findByMailingCarrierRoute", query = "SELECT s FROM StateTn s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateTn.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateTn s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateTn.findByStreetAddressCity", query = "SELECT s FROM StateTn s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateTn.findByStreetAddress", query = "SELECT s FROM StateTn s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateTn.findByStreetAddressZip", query = "SELECT s FROM StateTn s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateTn.findByStreetAddressZip4", query = "SELECT s FROM StateTn s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateTn.findByCounty", query = "SELECT s FROM StateTn s WHERE s.county = :county"),
    @NamedQuery(name = "StateTn.findByPhoneNumber", query = "SELECT s FROM StateTn s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateTn.findByFaxNumber", query = "SELECT s FROM StateTn s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateTn.findByWebAddress", query = "SELECT s FROM StateTn s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateTn.findByLastName", query = "SELECT s FROM StateTn s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateTn.findByFirstName", query = "SELECT s FROM StateTn s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateTn.findByContactTitle", query = "SELECT s FROM StateTn s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateTn.findByContactGender", query = "SELECT s FROM StateTn s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateTn.findByActualEmployeeSize", query = "SELECT s FROM StateTn s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateTn.findByEmployeeSizeRange", query = "SELECT s FROM StateTn s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateTn.findByActualSalesVolume", query = "SELECT s FROM StateTn s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateTn.findBySalesVolumeRange", query = "SELECT s FROM StateTn s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateTn.findByPrimarySic", query = "SELECT s FROM StateTn s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateTn.findByPrimarySicDescription", query = "SELECT s FROM StateTn s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateTn.findBySecondarySic1", query = "SELECT s FROM StateTn s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateTn.findBySecondarySicDescription1", query = "SELECT s FROM StateTn s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateTn.findBySecondarySic2", query = "SELECT s FROM StateTn s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateTn.findBySecondarySicDescription2", query = "SELECT s FROM StateTn s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateTn.findByCreditAlphaScore", query = "SELECT s FROM StateTn s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateTn.findByCreditNumericScore", query = "SELECT s FROM StateTn s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateTn.findByHeadquartersbranch", query = "SELECT s FROM StateTn s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateTn.findByOfficeSize", query = "SELECT s FROM StateTn s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateTn.findBySquareFootage", query = "SELECT s FROM StateTn s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateTn.findByFirmindividual", query = "SELECT s FROM StateTn s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateTn.findByPublicprivateFlag", query = "SELECT s FROM StateTn s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateTn.findByPcCode", query = "SELECT s FROM StateTn s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateTn.findByFranchisespecialty1", query = "SELECT s FROM StateTn s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateTn.findByFranchisespecialty2", query = "SELECT s FROM StateTn s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateTn.findByIndustrySpecificCodes", query = "SELECT s FROM StateTn s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateTn.findByAdsizeInYellowPages", query = "SELECT s FROM StateTn s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateTn.findByMetroArea", query = "SELECT s FROM StateTn s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateTn.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateTn s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateTn.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateTn s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateTn.findByRownum", query = "SELECT s FROM StateTn s WHERE s.rownum = :rownum")})
public class StateTn implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateTn)) {
            return false;
        }
        StateTn other = (StateTn) object;
    ...
    public String toString() {
        return "src.entities.StateTn[ rownum=" + rownum + " ]";
    }

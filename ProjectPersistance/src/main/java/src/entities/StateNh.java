...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateNh.findAll", query = "SELECT s FROM StateNh s"),
    @NamedQuery(name = "StateNh.findByCompanyName", query = "SELECT s FROM StateNh s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateNh.findByMailingAddress", query = "SELECT s FROM StateNh s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateNh.findByCity", query = "SELECT s FROM StateNh s WHERE s.city = :city"),
    @NamedQuery(name = "StateNh.findByState", query = "SELECT s FROM StateNh s WHERE s.state = :state"),
    @NamedQuery(name = "StateNh.findByZipCode", query = "SELECT s FROM StateNh s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateNh.findByMailingCarrierRoute", query = "SELECT s FROM StateNh s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateNh.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateNh s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateNh.findByStreetAddressCity", query = "SELECT s FROM StateNh s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateNh.findByStreetAddress", query = "SELECT s FROM StateNh s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateNh.findByStreetAddressZip", query = "SELECT s FROM StateNh s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateNh.findByStreetAddressZip4", query = "SELECT s FROM StateNh s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateNh.findByCounty", query = "SELECT s FROM StateNh s WHERE s.county = :county"),
    @NamedQuery(name = "StateNh.findByPhoneNumber", query = "SELECT s FROM StateNh s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateNh.findByFaxNumber", query = "SELECT s FROM StateNh s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateNh.findByWebAddress", query = "SELECT s FROM StateNh s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateNh.findByLastName", query = "SELECT s FROM StateNh s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateNh.findByFirstName", query = "SELECT s FROM StateNh s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateNh.findByContactTitle", query = "SELECT s FROM StateNh s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateNh.findByContactGender", query = "SELECT s FROM StateNh s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateNh.findByActualEmployeeSize", query = "SELECT s FROM StateNh s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateNh.findByEmployeeSizeRange", query = "SELECT s FROM StateNh s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateNh.findByActualSalesVolume", query = "SELECT s FROM StateNh s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateNh.findBySalesVolumeRange", query = "SELECT s FROM StateNh s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateNh.findByPrimarySic", query = "SELECT s FROM StateNh s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateNh.findByPrimarySicDescription", query = "SELECT s FROM StateNh s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateNh.findBySecondarySic1", query = "SELECT s FROM StateNh s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateNh.findBySecondarySicDescription1", query = "SELECT s FROM StateNh s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateNh.findBySecondarySic2", query = "SELECT s FROM StateNh s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateNh.findBySecondarySicDescription2", query = "SELECT s FROM StateNh s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateNh.findByCreditAlphaScore", query = "SELECT s FROM StateNh s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateNh.findByCreditNumericScore", query = "SELECT s FROM StateNh s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateNh.findByHeadquartersbranch", query = "SELECT s FROM StateNh s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateNh.findByOfficeSize", query = "SELECT s FROM StateNh s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateNh.findBySquareFootage", query = "SELECT s FROM StateNh s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateNh.findByFirmindividual", query = "SELECT s FROM StateNh s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateNh.findByPublicprivateFlag", query = "SELECT s FROM StateNh s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateNh.findByPcCode", query = "SELECT s FROM StateNh s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateNh.findByFranchisespecialty1", query = "SELECT s FROM StateNh s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateNh.findByFranchisespecialty2", query = "SELECT s FROM StateNh s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateNh.findByIndustrySpecificCodes", query = "SELECT s FROM StateNh s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateNh.findByAdsizeInYellowPages", query = "SELECT s FROM StateNh s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateNh.findByMetroArea", query = "SELECT s FROM StateNh s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateNh.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateNh s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateNh.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateNh s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateNh.findByRownum", query = "SELECT s FROM StateNh s WHERE s.rownum = :rownum")})
public class StateNh implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateNh)) {
            return false;
        }
        StateNh other = (StateNh) object;
    ...
    public String toString() {
        return "src.entities.StateNh[ rownum=" + rownum + " ]";
    }

...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateMt.findAll", query = "SELECT s FROM StateMt s"),
    @NamedQuery(name = "StateMt.findByCompanyName", query = "SELECT s FROM StateMt s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateMt.findByMailingAddress", query = "SELECT s FROM StateMt s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateMt.findByCity", query = "SELECT s FROM StateMt s WHERE s.city = :city"),
    @NamedQuery(name = "StateMt.findByState", query = "SELECT s FROM StateMt s WHERE s.state = :state"),
    @NamedQuery(name = "StateMt.findByZipCode", query = "SELECT s FROM StateMt s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateMt.findByMailingCarrierRoute", query = "SELECT s FROM StateMt s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateMt.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateMt s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateMt.findByStreetAddress", query = "SELECT s FROM StateMt s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateMt.findByStreetAddressCity", query = "SELECT s FROM StateMt s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateMt.findByStreetAddressState", query = "SELECT s FROM StateMt s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateMt.findByStreetAddressZip", query = "SELECT s FROM StateMt s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateMt.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateMt s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateMt.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateMt s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateMt.findByCounty", query = "SELECT s FROM StateMt s WHERE s.county = :county"),
    @NamedQuery(name = "StateMt.findByPhoneNumber", query = "SELECT s FROM StateMt s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateMt.findByFaxNumber", query = "SELECT s FROM StateMt s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateMt.findByWebAddress", query = "SELECT s FROM StateMt s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateMt.findByLastName", query = "SELECT s FROM StateMt s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateMt.findByFirstName", query = "SELECT s FROM StateMt s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateMt.findByContactTitle", query = "SELECT s FROM StateMt s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateMt.findByContactGender", query = "SELECT s FROM StateMt s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateMt.findByActualEmployeeSize", query = "SELECT s FROM StateMt s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateMt.findByEmployeeSizeRange", query = "SELECT s FROM StateMt s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateMt.findByActualSalesVolume", query = "SELECT s FROM StateMt s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateMt.findBySalesVolumeRange", query = "SELECT s FROM StateMt s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateMt.findByPrimarySic", query = "SELECT s FROM StateMt s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateMt.findByPrimarySicDescription", query = "SELECT s FROM StateMt s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateMt.findBySecondarySic1", query = "SELECT s FROM StateMt s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateMt.findBySecondarySicDescription1", query = "SELECT s FROM StateMt s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateMt.findBySecondarySic2", query = "SELECT s FROM StateMt s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateMt.findBySecondarySicDescription2", query = "SELECT s FROM StateMt s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateMt.findByCreditAlphaScore", query = "SELECT s FROM StateMt s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateMt.findByCreditNumericScore", query = "SELECT s FROM StateMt s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateMt.findByHeadquartersbranch", query = "SELECT s FROM StateMt s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateMt.findByOfficeSize", query = "SELECT s FROM StateMt s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateMt.findBySquareFootage", query = "SELECT s FROM StateMt s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateMt.findByFirmindividual", query = "SELECT s FROM StateMt s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateMt.findByPublicprivateFlag", query = "SELECT s FROM StateMt s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateMt.findByPcCode", query = "SELECT s FROM StateMt s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateMt.findByFranchisespecialty1", query = "SELECT s FROM StateMt s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateMt.findByFranchisespecialty2", query = "SELECT s FROM StateMt s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateMt.findByIndustrySpecificCodes", query = "SELECT s FROM StateMt s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateMt.findByAdsizeInYellowPages", query = "SELECT s FROM StateMt s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateMt.findByMetroArea", query = "SELECT s FROM StateMt s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateMt.findByRownum", query = "SELECT s FROM StateMt s WHERE s.rownum = :rownum")})
public class StateMt implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateMt)) {
            return false;
        }
        StateMt other = (StateMt) object;
    ...
    public String toString() {
        return "src.entities.StateMt[ rownum=" + rownum + " ]";
    }

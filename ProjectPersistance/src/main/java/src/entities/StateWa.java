...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateWa.findAll", query = "SELECT s FROM StateWa s"),
    @NamedQuery(name = "StateWa.findByCompanyName", query = "SELECT s FROM StateWa s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateWa.findByMailingAddress", query = "SELECT s FROM StateWa s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateWa.findByCity", query = "SELECT s FROM StateWa s WHERE s.city = :city"),
    @NamedQuery(name = "StateWa.findByState", query = "SELECT s FROM StateWa s WHERE s.state = :state"),
    @NamedQuery(name = "StateWa.findByZipCode", query = "SELECT s FROM StateWa s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateWa.findByMailingCarrierRoute", query = "SELECT s FROM StateWa s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateWa.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateWa s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateWa.findByStreetAddress", query = "SELECT s FROM StateWa s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateWa.findByStreetAddressCity", query = "SELECT s FROM StateWa s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateWa.findByStreetAddressState", query = "SELECT s FROM StateWa s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateWa.findByStreetAddressZip", query = "SELECT s FROM StateWa s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateWa.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateWa s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateWa.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateWa s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateWa.findByCounty", query = "SELECT s FROM StateWa s WHERE s.county = :county"),
    @NamedQuery(name = "StateWa.findByPhoneNumber", query = "SELECT s FROM StateWa s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateWa.findByFaxNumber", query = "SELECT s FROM StateWa s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateWa.findByWebAddress", query = "SELECT s FROM StateWa s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateWa.findByLastName", query = "SELECT s FROM StateWa s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateWa.findByFirstName", query = "SELECT s FROM StateWa s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateWa.findByContactTitle", query = "SELECT s FROM StateWa s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateWa.findByContactGender", query = "SELECT s FROM StateWa s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateWa.findByActualEmployeeSize", query = "SELECT s FROM StateWa s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateWa.findByEmployeeSizeRange", query = "SELECT s FROM StateWa s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateWa.findByActualSalesVolume", query = "SELECT s FROM StateWa s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateWa.findBySalesVolumeRange", query = "SELECT s FROM StateWa s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateWa.findByPrimarySic", query = "SELECT s FROM StateWa s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateWa.findByPrimarySicDescription", query = "SELECT s FROM StateWa s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateWa.findBySecondarySic1", query = "SELECT s FROM StateWa s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateWa.findBySecondarySicDescription1", query = "SELECT s FROM StateWa s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateWa.findBySecondarySic2", query = "SELECT s FROM StateWa s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateWa.findBySecondarySicDescription2", query = "SELECT s FROM StateWa s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateWa.findByCreditAlphaScore", query = "SELECT s FROM StateWa s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateWa.findByCreditNumericScore", query = "SELECT s FROM StateWa s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateWa.findByHeadquartersbranch", query = "SELECT s FROM StateWa s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateWa.findByYear1stAppeared", query = "SELECT s FROM StateWa s WHERE s.year1stAppeared = :year1stAppeared"),
    @NamedQuery(name = "StateWa.findByOfficeSize", query = "SELECT s FROM StateWa s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateWa.findBySquareFootage", query = "SELECT s FROM StateWa s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateWa.findByFirmindividual", query = "SELECT s FROM StateWa s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateWa.findByPublicprivateFlag", query = "SELECT s FROM StateWa s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateWa.findByPcCode", query = "SELECT s FROM StateWa s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateWa.findByFranchisespecialty1", query = "SELECT s FROM StateWa s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateWa.findByFranchisespecialty2", query = "SELECT s FROM StateWa s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateWa.findByIndustrySpecificCodes", query = "SELECT s FROM StateWa s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateWa.findByAdsizeInYellowPages", query = "SELECT s FROM StateWa s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateWa.findByMetroArea", query = "SELECT s FROM StateWa s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateWa.findByRownum", query = "SELECT s FROM StateWa s WHERE s.rownum = :rownum")})
public class StateWa implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateWa)) {
            return false;
        }
        StateWa other = (StateWa) object;
    ...
    public String toString() {
        return "src.entities.StateWa[ rownum=" + rownum + " ]";
    }

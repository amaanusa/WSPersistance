...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateNe.findAll", query = "SELECT s FROM StateNe s"),
    @NamedQuery(name = "StateNe.findByCompanyName", query = "SELECT s FROM StateNe s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateNe.findByMailingAddress", query = "SELECT s FROM StateNe s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateNe.findByCity", query = "SELECT s FROM StateNe s WHERE s.city = :city"),
    @NamedQuery(name = "StateNe.findByState", query = "SELECT s FROM StateNe s WHERE s.state = :state"),
    @NamedQuery(name = "StateNe.findByZipCode", query = "SELECT s FROM StateNe s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateNe.findByMailingCarrierRoute", query = "SELECT s FROM StateNe s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateNe.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateNe s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateNe.findByStreetAddressCity", query = "SELECT s FROM StateNe s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateNe.findByStreetAddress", query = "SELECT s FROM StateNe s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateNe.findByStreetAddressZip", query = "SELECT s FROM StateNe s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateNe.findByStreetAddressZip4", query = "SELECT s FROM StateNe s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateNe.findByCounty", query = "SELECT s FROM StateNe s WHERE s.county = :county"),
    @NamedQuery(name = "StateNe.findByPhoneNumber", query = "SELECT s FROM StateNe s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateNe.findByFaxNumber", query = "SELECT s FROM StateNe s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateNe.findByWebAddress", query = "SELECT s FROM StateNe s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateNe.findByLastName", query = "SELECT s FROM StateNe s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateNe.findByFirstName", query = "SELECT s FROM StateNe s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateNe.findByContactTitle", query = "SELECT s FROM StateNe s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateNe.findByContactGender", query = "SELECT s FROM StateNe s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateNe.findByActualEmployeeSize", query = "SELECT s FROM StateNe s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateNe.findByEmployeeSizeRange", query = "SELECT s FROM StateNe s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateNe.findByActualSalesVolume", query = "SELECT s FROM StateNe s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateNe.findBySalesVolumeRange", query = "SELECT s FROM StateNe s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateNe.findByPrimarySic", query = "SELECT s FROM StateNe s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateNe.findByPrimarySicDescription", query = "SELECT s FROM StateNe s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateNe.findBySecondarySic1", query = "SELECT s FROM StateNe s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateNe.findBySecondarySicDescription1", query = "SELECT s FROM StateNe s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateNe.findBySecondarySic2", query = "SELECT s FROM StateNe s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateNe.findBySecondarySicDescription2", query = "SELECT s FROM StateNe s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateNe.findByCreditAlphaScore", query = "SELECT s FROM StateNe s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateNe.findByCreditNumericScore", query = "SELECT s FROM StateNe s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateNe.findByHeadquartersbranch", query = "SELECT s FROM StateNe s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateNe.findByOfficeSize", query = "SELECT s FROM StateNe s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateNe.findBySquareFootage", query = "SELECT s FROM StateNe s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateNe.findByFirmindividual", query = "SELECT s FROM StateNe s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateNe.findByPublicprivateFlag", query = "SELECT s FROM StateNe s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateNe.findByPcCode", query = "SELECT s FROM StateNe s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateNe.findByFranchisespecialty1", query = "SELECT s FROM StateNe s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateNe.findByFranchisespecialty2", query = "SELECT s FROM StateNe s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateNe.findByIndustrySpecificCodes", query = "SELECT s FROM StateNe s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateNe.findByAdsizeInYellowPages", query = "SELECT s FROM StateNe s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateNe.findByMetroArea", query = "SELECT s FROM StateNe s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateNe.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateNe s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateNe.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateNe s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateNe.findByRownum", query = "SELECT s FROM StateNe s WHERE s.rownum = :rownum")})
public class StateNe implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateNe)) {
            return false;
        }
        StateNe other = (StateNe) object;
    ...
    public String toString() {
        return "src.entities.StateNe[ rownum=" + rownum + " ]";
    }

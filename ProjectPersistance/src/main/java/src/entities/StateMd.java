...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateMd.findAll", query = "SELECT s FROM StateMd s"),
    @NamedQuery(name = "StateMd.findByCompanyName", query = "SELECT s FROM StateMd s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateMd.findByMailingAddress", query = "SELECT s FROM StateMd s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateMd.findByCity", query = "SELECT s FROM StateMd s WHERE s.city = :city"),
    @NamedQuery(name = "StateMd.findByState", query = "SELECT s FROM StateMd s WHERE s.state = :state"),
    @NamedQuery(name = "StateMd.findByZipCode", query = "SELECT s FROM StateMd s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateMd.findByMailingCarrierRoute", query = "SELECT s FROM StateMd s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateMd.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateMd s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateMd.findByStreetAddress", query = "SELECT s FROM StateMd s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateMd.findByStreetAddressCity", query = "SELECT s FROM StateMd s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateMd.findByStreetAddressState", query = "SELECT s FROM StateMd s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateMd.findByStreetAddressZip", query = "SELECT s FROM StateMd s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateMd.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateMd s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateMd.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateMd s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateMd.findByCounty", query = "SELECT s FROM StateMd s WHERE s.county = :county"),
    @NamedQuery(name = "StateMd.findByPhoneNumber", query = "SELECT s FROM StateMd s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateMd.findByFaxNumber", query = "SELECT s FROM StateMd s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateMd.findByWebAddress", query = "SELECT s FROM StateMd s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateMd.findByLastName", query = "SELECT s FROM StateMd s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateMd.findByFirstName", query = "SELECT s FROM StateMd s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateMd.findByContactTitle", query = "SELECT s FROM StateMd s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateMd.findByContactGender", query = "SELECT s FROM StateMd s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateMd.findByActualEmployeeSize", query = "SELECT s FROM StateMd s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateMd.findByEmployeeSizeRange", query = "SELECT s FROM StateMd s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateMd.findByActualSalesVolume", query = "SELECT s FROM StateMd s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateMd.findBySalesVolumeRange", query = "SELECT s FROM StateMd s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateMd.findByPrimarySic", query = "SELECT s FROM StateMd s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateMd.findByPrimarySicDescription", query = "SELECT s FROM StateMd s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateMd.findBySecondarySic1", query = "SELECT s FROM StateMd s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateMd.findBySecondarySicDescription1", query = "SELECT s FROM StateMd s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateMd.findBySecondarySic2", query = "SELECT s FROM StateMd s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateMd.findBySecondarySicDescription2", query = "SELECT s FROM StateMd s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateMd.findByCreditAlphaScore", query = "SELECT s FROM StateMd s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateMd.findByCreditNumericScore", query = "SELECT s FROM StateMd s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateMd.findByHeadquartersbranch", query = "SELECT s FROM StateMd s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateMd.findByOfficeSize", query = "SELECT s FROM StateMd s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateMd.findBySquareFootage", query = "SELECT s FROM StateMd s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateMd.findByFirmindividual", query = "SELECT s FROM StateMd s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateMd.findByPublicprivateFlag", query = "SELECT s FROM StateMd s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateMd.findByPcCode", query = "SELECT s FROM StateMd s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateMd.findByFranchisespecialty1", query = "SELECT s FROM StateMd s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateMd.findByFranchisespecialty2", query = "SELECT s FROM StateMd s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateMd.findByIndustrySpecificCodes", query = "SELECT s FROM StateMd s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateMd.findByAdsizeInYellowPages", query = "SELECT s FROM StateMd s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateMd.findByMetroArea", query = "SELECT s FROM StateMd s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateMd.findByRownum", query = "SELECT s FROM StateMd s WHERE s.rownum = :rownum")})
public class StateMd implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateMd)) {
            return false;
        }
        StateMd other = (StateMd) object;
    ...
    public String toString() {
        return "src.entities.StateMd[ rownum=" + rownum + " ]";
    }

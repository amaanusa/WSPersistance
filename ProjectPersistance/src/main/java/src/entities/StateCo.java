...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateCo.findAll", query = "SELECT s FROM StateCo s"),
    @NamedQuery(name = "StateCo.findByCompanyName", query = "SELECT s FROM StateCo s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateCo.findByMailingAddress", query = "SELECT s FROM StateCo s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateCo.findByCity", query = "SELECT s FROM StateCo s WHERE s.city = :city"),
    @NamedQuery(name = "StateCo.findByState", query = "SELECT s FROM StateCo s WHERE s.state = :state"),
    @NamedQuery(name = "StateCo.findByZipCode", query = "SELECT s FROM StateCo s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateCo.findByMailingCarrierRoute", query = "SELECT s FROM StateCo s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateCo.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateCo s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateCo.findByStreetAddressCity", query = "SELECT s FROM StateCo s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateCo.findByStreetAddress", query = "SELECT s FROM StateCo s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateCo.findByStreetAddressZip", query = "SELECT s FROM StateCo s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateCo.findByStreetAddressZip4", query = "SELECT s FROM StateCo s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateCo.findByCounty", query = "SELECT s FROM StateCo s WHERE s.county = :county"),
    @NamedQuery(name = "StateCo.findByPhoneNumber", query = "SELECT s FROM StateCo s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateCo.findByFaxNumber", query = "SELECT s FROM StateCo s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateCo.findByWebAddress", query = "SELECT s FROM StateCo s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateCo.findByLastName", query = "SELECT s FROM StateCo s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateCo.findByFirstName", query = "SELECT s FROM StateCo s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateCo.findByContactTitle", query = "SELECT s FROM StateCo s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateCo.findByContactGender", query = "SELECT s FROM StateCo s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateCo.findByActualEmployeeSize", query = "SELECT s FROM StateCo s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateCo.findByEmployeeSizeRange", query = "SELECT s FROM StateCo s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateCo.findByActualSalesVolume", query = "SELECT s FROM StateCo s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateCo.findBySalesVolumeRange", query = "SELECT s FROM StateCo s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateCo.findByPrimarySic", query = "SELECT s FROM StateCo s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateCo.findByPrimarySicDescription", query = "SELECT s FROM StateCo s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateCo.findBySecondarySic1", query = "SELECT s FROM StateCo s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateCo.findBySecondarySicDescription1", query = "SELECT s FROM StateCo s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateCo.findBySecondarySic2", query = "SELECT s FROM StateCo s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateCo.findBySecondarySicDescription2", query = "SELECT s FROM StateCo s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateCo.findByCreditAlphaScore", query = "SELECT s FROM StateCo s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateCo.findByCreditNumericScore", query = "SELECT s FROM StateCo s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateCo.findByHeadquartersbranch", query = "SELECT s FROM StateCo s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateCo.findByYear1stAppeared", query = "SELECT s FROM StateCo s WHERE s.year1stAppeared = :year1stAppeared"),
    @NamedQuery(name = "StateCo.findByOfficeSize", query = "SELECT s FROM StateCo s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateCo.findBySquareFootage", query = "SELECT s FROM StateCo s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateCo.findByFirmindividual", query = "SELECT s FROM StateCo s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateCo.findByPublicprivateFlag", query = "SELECT s FROM StateCo s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateCo.findByPcCode", query = "SELECT s FROM StateCo s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateCo.findByFranchisespecialty1", query = "SELECT s FROM StateCo s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateCo.findByFranchisespecialty2", query = "SELECT s FROM StateCo s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateCo.findByIndustrySpecificCodes", query = "SELECT s FROM StateCo s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateCo.findByAdsizeInYellowPages", query = "SELECT s FROM StateCo s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateCo.findByMetroArea", query = "SELECT s FROM StateCo s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateCo.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateCo s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateCo.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateCo s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateCo.findByRownum", query = "SELECT s FROM StateCo s WHERE s.rownum = :rownum")})
public class StateCo implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateCo)) {
            return false;
        }
        StateCo other = (StateCo) object;
    ...
    public String toString() {
        return "src.entities.StateCo[ rownum=" + rownum + " ]";
    }

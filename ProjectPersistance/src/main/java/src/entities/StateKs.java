...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateKs.findAll", query = "SELECT s FROM StateKs s"),
    @NamedQuery(name = "StateKs.findByCompanyName", query = "SELECT s FROM StateKs s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateKs.findByMailingAddress", query = "SELECT s FROM StateKs s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateKs.findByCity", query = "SELECT s FROM StateKs s WHERE s.city = :city"),
    @NamedQuery(name = "StateKs.findByState", query = "SELECT s FROM StateKs s WHERE s.state = :state"),
    @NamedQuery(name = "StateKs.findByZipCode", query = "SELECT s FROM StateKs s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateKs.findByMailingCarrierRoute", query = "SELECT s FROM StateKs s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateKs.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateKs s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateKs.findByStreetAddress", query = "SELECT s FROM StateKs s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateKs.findByStreetAddressCity", query = "SELECT s FROM StateKs s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateKs.findByStreetAddressState", query = "SELECT s FROM StateKs s WHERE s.streetAddressState = :streetAddressState"),
    @NamedQuery(name = "StateKs.findByStreetAddressZip", query = "SELECT s FROM StateKs s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateKs.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateKs s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateKs.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateKs s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateKs.findByCounty", query = "SELECT s FROM StateKs s WHERE s.county = :county"),
    @NamedQuery(name = "StateKs.findByPhoneNumber", query = "SELECT s FROM StateKs s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateKs.findByFaxNumber", query = "SELECT s FROM StateKs s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateKs.findByWebAddress", query = "SELECT s FROM StateKs s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateKs.findByLastName", query = "SELECT s FROM StateKs s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateKs.findByFirstName", query = "SELECT s FROM StateKs s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateKs.findByContactTitle", query = "SELECT s FROM StateKs s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateKs.findByContactGender", query = "SELECT s FROM StateKs s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateKs.findByActualEmployeeSize", query = "SELECT s FROM StateKs s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateKs.findByEmployeeSizeRange", query = "SELECT s FROM StateKs s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateKs.findByActualSalesVolume", query = "SELECT s FROM StateKs s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateKs.findBySalesVolumeRange", query = "SELECT s FROM StateKs s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateKs.findByPrimarySic", query = "SELECT s FROM StateKs s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateKs.findByPrimarySicDescription", query = "SELECT s FROM StateKs s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateKs.findBySecondarySic1", query = "SELECT s FROM StateKs s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateKs.findBySecondarySicDescription1", query = "SELECT s FROM StateKs s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateKs.findBySecondarySic2", query = "SELECT s FROM StateKs s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateKs.findBySecondarySicDescription2", query = "SELECT s FROM StateKs s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateKs.findByCreditAlphaScore", query = "SELECT s FROM StateKs s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateKs.findByCreditNumericScore", query = "SELECT s FROM StateKs s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateKs.findByHeadquartersbranch", query = "SELECT s FROM StateKs s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateKs.findByOfficeSize", query = "SELECT s FROM StateKs s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateKs.findBySquareFootage", query = "SELECT s FROM StateKs s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateKs.findByFirmindividual", query = "SELECT s FROM StateKs s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateKs.findByPublicprivateFlag", query = "SELECT s FROM StateKs s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateKs.findByPcCode", query = "SELECT s FROM StateKs s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateKs.findByFranchisespecialty1", query = "SELECT s FROM StateKs s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateKs.findByFranchisespecialty2", query = "SELECT s FROM StateKs s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateKs.findByIndustrySpecificCodes", query = "SELECT s FROM StateKs s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateKs.findByAdsizeInYellowPages", query = "SELECT s FROM StateKs s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateKs.findByMetroArea", query = "SELECT s FROM StateKs s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateKs.findByRownum", query = "SELECT s FROM StateKs s WHERE s.rownum = :rownum")})
public class StateKs implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateKs)) {
            return false;
        }
        StateKs other = (StateKs) object;
    ...
    public String toString() {
        return "src.entities.StateKs[ rownum=" + rownum + " ]";
    }

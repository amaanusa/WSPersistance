...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateAk.findAll", query = "SELECT s FROM StateAk s"),
    @NamedQuery(name = "StateAk.findByCompanyName", query = "SELECT s FROM StateAk s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateAk.findByMailingAddress", query = "SELECT s FROM StateAk s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateAk.findByCity", query = "SELECT s FROM StateAk s WHERE s.city = :city"),
    @NamedQuery(name = "StateAk.findByState", query = "SELECT s FROM StateAk s WHERE s.state = :state"),
    @NamedQuery(name = "StateAk.findByZipCode", query = "SELECT s FROM StateAk s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateAk.findByMailingCarrierRoute", query = "SELECT s FROM StateAk s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateAk.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateAk s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateAk.findByStreetAddressCity", query = "SELECT s FROM StateAk s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateAk.findByStreetAddress", query = "SELECT s FROM StateAk s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateAk.findByStreetAddressZip", query = "SELECT s FROM StateAk s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateAk.findByStreetAddressZip4", query = "SELECT s FROM StateAk s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateAk.findByCounty", query = "SELECT s FROM StateAk s WHERE s.county = :county"),
    @NamedQuery(name = "StateAk.findByPhoneNumber", query = "SELECT s FROM StateAk s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateAk.findByFaxNumber", query = "SELECT s FROM StateAk s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateAk.findByWebAddress", query = "SELECT s FROM StateAk s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateAk.findByLastName", query = "SELECT s FROM StateAk s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateAk.findByFirstName", query = "SELECT s FROM StateAk s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateAk.findByContactTitle", query = "SELECT s FROM StateAk s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateAk.findByContactGender", query = "SELECT s FROM StateAk s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateAk.findByActualEmployeeSize", query = "SELECT s FROM StateAk s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateAk.findByEmployeeSizeRange", query = "SELECT s FROM StateAk s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateAk.findByActualSalesVolume", query = "SELECT s FROM StateAk s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateAk.findBySalesVolumeRange", query = "SELECT s FROM StateAk s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateAk.findByPrimarySic", query = "SELECT s FROM StateAk s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateAk.findByPrimarySicDescription", query = "SELECT s FROM StateAk s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateAk.findBySecondarySic1", query = "SELECT s FROM StateAk s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateAk.findBySecondarySicDescription1", query = "SELECT s FROM StateAk s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateAk.findBySecondarySic2", query = "SELECT s FROM StateAk s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateAk.findBySecondarySicDescription2", query = "SELECT s FROM StateAk s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateAk.findByCreditAlphaScore", query = "SELECT s FROM StateAk s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateAk.findByCreditNumericScore", query = "SELECT s FROM StateAk s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateAk.findByHeadquartersbranch", query = "SELECT s FROM StateAk s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateAk.findByYear1stAppeared", query = "SELECT s FROM StateAk s WHERE s.year1stAppeared = :year1stAppeared"),
    @NamedQuery(name = "StateAk.findByOfficeSize", query = "SELECT s FROM StateAk s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateAk.findBySquareFootage", query = "SELECT s FROM StateAk s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateAk.findByFirmindividual", query = "SELECT s FROM StateAk s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateAk.findByPublicprivateFlag", query = "SELECT s FROM StateAk s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateAk.findByPcCode", query = "SELECT s FROM StateAk s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateAk.findByFranchisespecialty1", query = "SELECT s FROM StateAk s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateAk.findByFranchisespecialty2", query = "SELECT s FROM StateAk s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateAk.findByIndustrySpecificCodes", query = "SELECT s FROM StateAk s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateAk.findByAdsizeInYellowPages", query = "SELECT s FROM StateAk s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateAk.findByMetroArea", query = "SELECT s FROM StateAk s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateAk.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateAk s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateAk.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateAk s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateAk.findByRownum", query = "SELECT s FROM StateAk s WHERE s.rownum = :rownum")})
public class StateAk implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateAk)) {
            return false;
        }
        StateAk other = (StateAk) object;
    ...
    public String toString() {
        return "src.entities.StateAk[ rownum=" + rownum + " ]";
    }

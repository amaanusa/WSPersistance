...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateCt.findAll", query = "SELECT s FROM StateCt s"),
    @NamedQuery(name = "StateCt.findByCompanyName", query = "SELECT s FROM StateCt s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateCt.findByMailingAddress", query = "SELECT s FROM StateCt s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateCt.findByCity", query = "SELECT s FROM StateCt s WHERE s.city = :city"),
    @NamedQuery(name = "StateCt.findByState", query = "SELECT s FROM StateCt s WHERE s.state = :state"),
    @NamedQuery(name = "StateCt.findByZipCode", query = "SELECT s FROM StateCt s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateCt.findByMailingCarrierRoute", query = "SELECT s FROM StateCt s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateCt.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateCt s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateCt.findByStreetAddressCity", query = "SELECT s FROM StateCt s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateCt.findByStreetAddress", query = "SELECT s FROM StateCt s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateCt.findByStreetAddressZip", query = "SELECT s FROM StateCt s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateCt.findByStreetAddressZip4", query = "SELECT s FROM StateCt s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateCt.findByCounty", query = "SELECT s FROM StateCt s WHERE s.county = :county"),
    @NamedQuery(name = "StateCt.findByPhoneNumber", query = "SELECT s FROM StateCt s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateCt.findByFaxNumber", query = "SELECT s FROM StateCt s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateCt.findByWebAddress", query = "SELECT s FROM StateCt s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateCt.findByLastName", query = "SELECT s FROM StateCt s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateCt.findByFirstName", query = "SELECT s FROM StateCt s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateCt.findByContactTitle", query = "SELECT s FROM StateCt s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateCt.findByContactGender", query = "SELECT s FROM StateCt s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateCt.findByActualEmployeeSize", query = "SELECT s FROM StateCt s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateCt.findByEmployeeSizeRange", query = "SELECT s FROM StateCt s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateCt.findByActualSalesVolume", query = "SELECT s FROM StateCt s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateCt.findBySalesVolumeRange", query = "SELECT s FROM StateCt s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateCt.findByPrimarySic", query = "SELECT s FROM StateCt s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateCt.findByPrimarySicDescription", query = "SELECT s FROM StateCt s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateCt.findBySecondarySic1", query = "SELECT s FROM StateCt s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateCt.findBySecondarySicDescription1", query = "SELECT s FROM StateCt s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateCt.findBySecondarySic2", query = "SELECT s FROM StateCt s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateCt.findBySecondarySicDescription2", query = "SELECT s FROM StateCt s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateCt.findByCreditAlphaScore", query = "SELECT s FROM StateCt s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateCt.findByCreditNumericScore", query = "SELECT s FROM StateCt s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateCt.findByHeadquartersbranch", query = "SELECT s FROM StateCt s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateCt.findByOfficeSize", query = "SELECT s FROM StateCt s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateCt.findBySquareFootage", query = "SELECT s FROM StateCt s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateCt.findByFirmindividual", query = "SELECT s FROM StateCt s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateCt.findByPublicprivateFlag", query = "SELECT s FROM StateCt s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateCt.findByPcCode", query = "SELECT s FROM StateCt s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateCt.findByFranchisespecialty1", query = "SELECT s FROM StateCt s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateCt.findByFranchisespecialty2", query = "SELECT s FROM StateCt s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateCt.findByIndustrySpecificCodes", query = "SELECT s FROM StateCt s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateCt.findByAdsizeInYellowPages", query = "SELECT s FROM StateCt s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateCt.findByMetroArea", query = "SELECT s FROM StateCt s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateCt.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateCt s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateCt.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateCt s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateCt.findByRownum", query = "SELECT s FROM StateCt s WHERE s.rownum = :rownum")})
public class StateCt implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateCt)) {
            return false;
        }
        StateCt other = (StateCt) object;
    ...
    public String toString() {
        return "src.entities.StateCt[ rownum=" + rownum + " ]";
    }

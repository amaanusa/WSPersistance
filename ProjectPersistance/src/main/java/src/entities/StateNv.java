...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateNv.findAll", query = "SELECT s FROM StateNv s"),
    @NamedQuery(name = "StateNv.findByCompanyName", query = "SELECT s FROM StateNv s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateNv.findByMailingAddress", query = "SELECT s FROM StateNv s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateNv.findByCity", query = "SELECT s FROM StateNv s WHERE s.city = :city"),
    @NamedQuery(name = "StateNv.findByState", query = "SELECT s FROM StateNv s WHERE s.state = :state"),
    @NamedQuery(name = "StateNv.findByZipCode", query = "SELECT s FROM StateNv s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateNv.findByMailingCarrierRoute", query = "SELECT s FROM StateNv s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateNv.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateNv s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateNv.findByStreetAddressCity", query = "SELECT s FROM StateNv s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateNv.findByStreetAddress", query = "SELECT s FROM StateNv s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateNv.findByStreetAddressZip", query = "SELECT s FROM StateNv s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateNv.findByStreetAddressZip4", query = "SELECT s FROM StateNv s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateNv.findByCounty", query = "SELECT s FROM StateNv s WHERE s.county = :county"),
    @NamedQuery(name = "StateNv.findByPhoneNumber", query = "SELECT s FROM StateNv s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateNv.findByFaxNumber", query = "SELECT s FROM StateNv s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateNv.findByWebAddress", query = "SELECT s FROM StateNv s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateNv.findByLastName", query = "SELECT s FROM StateNv s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateNv.findByFirstName", query = "SELECT s FROM StateNv s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateNv.findByContactTitle", query = "SELECT s FROM StateNv s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateNv.findByContactGender", query = "SELECT s FROM StateNv s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateNv.findByActualEmployeeSize", query = "SELECT s FROM StateNv s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateNv.findByEmployeeSizeRange", query = "SELECT s FROM StateNv s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateNv.findByActualSalesVolume", query = "SELECT s FROM StateNv s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateNv.findBySalesVolumeRange", query = "SELECT s FROM StateNv s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateNv.findByPrimarySic", query = "SELECT s FROM StateNv s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateNv.findByPrimarySicDescription", query = "SELECT s FROM StateNv s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateNv.findBySecondarySic1", query = "SELECT s FROM StateNv s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateNv.findBySecondarySicDescription1", query = "SELECT s FROM StateNv s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateNv.findBySecondarySic2", query = "SELECT s FROM StateNv s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateNv.findBySecondarySicDescription2", query = "SELECT s FROM StateNv s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateNv.findByCreditAlphaScore", query = "SELECT s FROM StateNv s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateNv.findByCreditNumericScore", query = "SELECT s FROM StateNv s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateNv.findByHeadquartersbranch", query = "SELECT s FROM StateNv s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateNv.findByOfficeSize", query = "SELECT s FROM StateNv s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateNv.findBySquareFootage", query = "SELECT s FROM StateNv s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateNv.findByFirmindividual", query = "SELECT s FROM StateNv s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateNv.findByPublicprivateFlag", query = "SELECT s FROM StateNv s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateNv.findByPcCode", query = "SELECT s FROM StateNv s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateNv.findByFranchisespecialty1", query = "SELECT s FROM StateNv s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateNv.findByFranchisespecialty2", query = "SELECT s FROM StateNv s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateNv.findByIndustrySpecificCodes", query = "SELECT s FROM StateNv s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateNv.findByAdsizeInYellowPages", query = "SELECT s FROM StateNv s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateNv.findByMetroArea", query = "SELECT s FROM StateNv s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateNv.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateNv s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateNv.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateNv s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateNv.findByRownum", query = "SELECT s FROM StateNv s WHERE s.rownum = :rownum")})
public class StateNv implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateNv)) {
            return false;
        }
        StateNv other = (StateNv) object;
    ...
    public String toString() {
        return "src.entities.StateNv[ rownum=" + rownum + " ]";
    }

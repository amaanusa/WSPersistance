...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateMo.findAll", query = "SELECT s FROM StateMo s"),
    @NamedQuery(name = "StateMo.findByCompanyName", query = "SELECT s FROM StateMo s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateMo.findByMailingAddress", query = "SELECT s FROM StateMo s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateMo.findByCity", query = "SELECT s FROM StateMo s WHERE s.city = :city"),
    @NamedQuery(name = "StateMo.findByState", query = "SELECT s FROM StateMo s WHERE s.state = :state"),
    @NamedQuery(name = "StateMo.findByZipCode", query = "SELECT s FROM StateMo s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateMo.findByMailingCarrierRoute", query = "SELECT s FROM StateMo s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateMo.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateMo s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateMo.findByStreetAddressCity", query = "SELECT s FROM StateMo s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateMo.findByStreetAddress", query = "SELECT s FROM StateMo s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateMo.findByStreetAddressZip", query = "SELECT s FROM StateMo s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateMo.findByStreetAddressZip4", query = "SELECT s FROM StateMo s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateMo.findByCounty", query = "SELECT s FROM StateMo s WHERE s.county = :county"),
    @NamedQuery(name = "StateMo.findByPhoneNumber", query = "SELECT s FROM StateMo s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateMo.findByFaxNumber", query = "SELECT s FROM StateMo s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateMo.findByWebAddress", query = "SELECT s FROM StateMo s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateMo.findByLastName", query = "SELECT s FROM StateMo s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateMo.findByFirstName", query = "SELECT s FROM StateMo s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateMo.findByContactTitle", query = "SELECT s FROM StateMo s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateMo.findByContactGender", query = "SELECT s FROM StateMo s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateMo.findByActualEmployeeSize", query = "SELECT s FROM StateMo s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateMo.findByEmployeeSizeRange", query = "SELECT s FROM StateMo s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateMo.findByActualSalesVolume", query = "SELECT s FROM StateMo s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateMo.findBySalesVolumeRange", query = "SELECT s FROM StateMo s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateMo.findByPrimarySic", query = "SELECT s FROM StateMo s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateMo.findByPrimarySicDescription", query = "SELECT s FROM StateMo s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateMo.findBySecondarySic1", query = "SELECT s FROM StateMo s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateMo.findBySecondarySicDescription1", query = "SELECT s FROM StateMo s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateMo.findBySecondarySic2", query = "SELECT s FROM StateMo s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateMo.findBySecondarySicDescription2", query = "SELECT s FROM StateMo s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateMo.findByCreditAlphaScore", query = "SELECT s FROM StateMo s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateMo.findByCreditNumericScore", query = "SELECT s FROM StateMo s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateMo.findByHeadquartersbranch", query = "SELECT s FROM StateMo s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateMo.findByOfficeSize", query = "SELECT s FROM StateMo s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateMo.findBySquareFootage", query = "SELECT s FROM StateMo s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateMo.findByFirmindividual", query = "SELECT s FROM StateMo s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateMo.findByPublicprivateFlag", query = "SELECT s FROM StateMo s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateMo.findByPcCode", query = "SELECT s FROM StateMo s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateMo.findByFranchisespecialty1", query = "SELECT s FROM StateMo s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateMo.findByFranchisespecialty2", query = "SELECT s FROM StateMo s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateMo.findByIndustrySpecificCodes", query = "SELECT s FROM StateMo s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateMo.findByAdsizeInYellowPages", query = "SELECT s FROM StateMo s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateMo.findByMetroArea", query = "SELECT s FROM StateMo s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateMo.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateMo s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateMo.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateMo s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateMo.findByRownum", query = "SELECT s FROM StateMo s WHERE s.rownum = :rownum")})
public class StateMo implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateMo)) {
            return false;
        }
        StateMo other = (StateMo) object;
    ...
    public String toString() {
        return "src.entities.StateMo[ rownum=" + rownum + " ]";
    }

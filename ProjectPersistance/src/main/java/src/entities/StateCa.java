...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StateCa.findAll", query = "SELECT s FROM StateCa s"),
    @NamedQuery(name = "StateCa.findByCompanyName", query = "SELECT s FROM StateCa s WHERE s.companyName = :companyName"),
    @NamedQuery(name = "StateCa.findByMailingAddress", query = "SELECT s FROM StateCa s WHERE s.mailingAddress = :mailingAddress"),
    @NamedQuery(name = "StateCa.findByCity", query = "SELECT s FROM StateCa s WHERE s.city = :city"),
    @NamedQuery(name = "StateCa.findByState", query = "SELECT s FROM StateCa s WHERE s.state = :state"),
    @NamedQuery(name = "StateCa.findByZipCode", query = "SELECT s FROM StateCa s WHERE s.zipCode = :zipCode"),
    @NamedQuery(name = "StateCa.findByMailingCarrierRoute", query = "SELECT s FROM StateCa s WHERE s.mailingCarrierRoute = :mailingCarrierRoute"),
    @NamedQuery(name = "StateCa.findByMailingDeliveryPointBarCode", query = "SELECT s FROM StateCa s WHERE s.mailingDeliveryPointBarCode = :mailingDeliveryPointBarCode"),
    @NamedQuery(name = "StateCa.findByStreetAddressCity", query = "SELECT s FROM StateCa s WHERE s.streetAddressCity = :streetAddressCity"),
    @NamedQuery(name = "StateCa.findByStreetAddress", query = "SELECT s FROM StateCa s WHERE s.streetAddress = :streetAddress"),
    @NamedQuery(name = "StateCa.findByStreetAddressZip", query = "SELECT s FROM StateCa s WHERE s.streetAddressZip = :streetAddressZip"),
    @NamedQuery(name = "StateCa.findByStreetAddressZip4", query = "SELECT s FROM StateCa s WHERE s.streetAddressZip4 = :streetAddressZip4"),
    @NamedQuery(name = "StateCa.findByCounty", query = "SELECT s FROM StateCa s WHERE s.county = :county"),
    @NamedQuery(name = "StateCa.findByPhoneNumber", query = "SELECT s FROM StateCa s WHERE s.phoneNumber = :phoneNumber"),
    @NamedQuery(name = "StateCa.findByFaxNumber", query = "SELECT s FROM StateCa s WHERE s.faxNumber = :faxNumber"),
    @NamedQuery(name = "StateCa.findByWebAddress", query = "SELECT s FROM StateCa s WHERE s.webAddress = :webAddress"),
    @NamedQuery(name = "StateCa.findByLastName", query = "SELECT s FROM StateCa s WHERE s.lastName = :lastName"),
    @NamedQuery(name = "StateCa.findByFirstName", query = "SELECT s FROM StateCa s WHERE s.firstName = :firstName"),
    @NamedQuery(name = "StateCa.findByContactTitle", query = "SELECT s FROM StateCa s WHERE s.contactTitle = :contactTitle"),
    @NamedQuery(name = "StateCa.findByContactGender", query = "SELECT s FROM StateCa s WHERE s.contactGender = :contactGender"),
    @NamedQuery(name = "StateCa.findByActualEmployeeSize", query = "SELECT s FROM StateCa s WHERE s.actualEmployeeSize = :actualEmployeeSize"),
    @NamedQuery(name = "StateCa.findByEmployeeSizeRange", query = "SELECT s FROM StateCa s WHERE s.employeeSizeRange = :employeeSizeRange"),
    @NamedQuery(name = "StateCa.findByActualSalesVolume", query = "SELECT s FROM StateCa s WHERE s.actualSalesVolume = :actualSalesVolume"),
    @NamedQuery(name = "StateCa.findBySalesVolumeRange", query = "SELECT s FROM StateCa s WHERE s.salesVolumeRange = :salesVolumeRange"),
    @NamedQuery(name = "StateCa.findByPrimarySic", query = "SELECT s FROM StateCa s WHERE s.primarySic = :primarySic"),
    @NamedQuery(name = "StateCa.findByPrimarySicDescription", query = "SELECT s FROM StateCa s WHERE s.primarySicDescription = :primarySicDescription"),
    @NamedQuery(name = "StateCa.findBySecondarySic1", query = "SELECT s FROM StateCa s WHERE s.secondarySic1 = :secondarySic1"),
    @NamedQuery(name = "StateCa.findBySecondarySicDescription1", query = "SELECT s FROM StateCa s WHERE s.secondarySicDescription1 = :secondarySicDescription1"),
    @NamedQuery(name = "StateCa.findBySecondarySic2", query = "SELECT s FROM StateCa s WHERE s.secondarySic2 = :secondarySic2"),
    @NamedQuery(name = "StateCa.findBySecondarySicDescription2", query = "SELECT s FROM StateCa s WHERE s.secondarySicDescription2 = :secondarySicDescription2"),
    @NamedQuery(name = "StateCa.findByCreditAlphaScore", query = "SELECT s FROM StateCa s WHERE s.creditAlphaScore = :creditAlphaScore"),
    @NamedQuery(name = "StateCa.findByCreditNumericScore", query = "SELECT s FROM StateCa s WHERE s.creditNumericScore = :creditNumericScore"),
    @NamedQuery(name = "StateCa.findByHeadquartersbranch", query = "SELECT s FROM StateCa s WHERE s.headquartersbranch = :headquartersbranch"),
    @NamedQuery(name = "StateCa.findByOfficeSize", query = "SELECT s FROM StateCa s WHERE s.officeSize = :officeSize"),
    @NamedQuery(name = "StateCa.findBySquareFootage", query = "SELECT s FROM StateCa s WHERE s.squareFootage = :squareFootage"),
    @NamedQuery(name = "StateCa.findByFirmindividual", query = "SELECT s FROM StateCa s WHERE s.firmindividual = :firmindividual"),
    @NamedQuery(name = "StateCa.findByPublicprivateFlag", query = "SELECT s FROM StateCa s WHERE s.publicprivateFlag = :publicprivateFlag"),
    @NamedQuery(name = "StateCa.findByPcCode", query = "SELECT s FROM StateCa s WHERE s.pcCode = :pcCode"),
    @NamedQuery(name = "StateCa.findByFranchisespecialty1", query = "SELECT s FROM StateCa s WHERE s.franchisespecialty1 = :franchisespecialty1"),
    @NamedQuery(name = "StateCa.findByFranchisespecialty2", query = "SELECT s FROM StateCa s WHERE s.franchisespecialty2 = :franchisespecialty2"),
    @NamedQuery(name = "StateCa.findByIndustrySpecificCodes", query = "SELECT s FROM StateCa s WHERE s.industrySpecificCodes = :industrySpecificCodes"),
    @NamedQuery(name = "StateCa.findByAdsizeInYellowPages", query = "SELECT s FROM StateCa s WHERE s.adsizeInYellowPages = :adsizeInYellowPages"),
    @NamedQuery(name = "StateCa.findByMetroArea", query = "SELECT s FROM StateCa s WHERE s.metroArea = :metroArea"),
    @NamedQuery(name = "StateCa.findByStreetAddressDeliveryPointBarCode", query = "SELECT s FROM StateCa s WHERE s.streetAddressDeliveryPointBarCode = :streetAddressDeliveryPointBarCode"),
    @NamedQuery(name = "StateCa.findByStreetAddressCarrierRoute", query = "SELECT s FROM StateCa s WHERE s.streetAddressCarrierRoute = :streetAddressCarrierRoute"),
    @NamedQuery(name = "StateCa.findByRownum", query = "SELECT s FROM StateCa s WHERE s.rownum = :rownum")})
public class StateCa implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StateCa)) {
            return false;
        }
        StateCa other = (StateCa) object;
    ...
    public String toString() {
        return "src.entities.StateCa[ rownum=" + rownum + " ]";
    }
